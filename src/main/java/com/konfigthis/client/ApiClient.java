...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.zoom.us/v2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("openapi_authorization", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.openapiAuthorization != null) {
                this.setOpenapiAuthorization(configuration.openapiAuthorization);
            }
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("openapi_oauth", oauth);
        return oauth;
    }

    public String getOpenapiAuthorization() {
        return ((ApiKeyAuth) this.getAuthentication("openapi_authorization")).getApiKey();
    }

    public void setOpenapiAuthorization(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("openapi_authorization")).setApiKey(apiKey);
    }

    public void setOpenapiAuthorizationPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("openapi_authorization")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.zoom.us/v2)
