...
public class MeetingsGetDetailsResponseRecurrence {
 ...
 public enum WeeklyDaysEnum {
  ...
  public MeetingsGetDetailsResponseRecurrence() {
  }

  public MeetingsGetDetailsResponseRecurrence endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence endTimes(Integer endTimes) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence repeatInterval(Integer repeatInterval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Define the interval when the meeting should recur. For instance, to schedule a meeting that recurs every two months, you must set this field's value as `2` and the `type` parameter's value as `3`.   For a daily meeting, the maximum interval you can set is `90` days. For a weekly meeting the maximum interval that you can set is  of `12` weeks. For a monthly meeting, there is a maximum of `3` months.  ")
  ...
  public MeetingsGetDetailsResponseRecurrence type(TypeEnum type) {
  ...
  **/
  ...
  public MeetingsGetDetailsResponseRecurrence weeklyDays(WeeklyDaysEnum weeklyDays) {
  ...
  **/
   ...
   * @return the MeetingsGetDetailsResponseRecurrence instance itself
   */
  public MeetingsGetDetailsResponseRecurrence putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsGetDetailsResponseRecurrence meetingsGetDetailsResponseRecurrence = (MeetingsGetDetailsResponseRecurrence) o;
    return Objects.equals(this.endDateTime, meetingsGetDetailsResponseRecurrence.endDateTime) &&
        Objects.equals(this.endTimes, meetingsGetDetailsResponseRecurrence.endTimes) &&
        Objects.equals(this.monthlyDay, meetingsGetDetailsResponseRecurrence.monthlyDay) &&
        Objects.equals(this.monthlyWeek, meetingsGetDetailsResponseRecurrence.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, meetingsGetDetailsResponseRecurrence.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, meetingsGetDetailsResponseRecurrence.repeatInterval) &&
        Objects.equals(this.type, meetingsGetDetailsResponseRecurrence.type) &&
        Objects.equals(this.weeklyDays, meetingsGetDetailsResponseRecurrence.weeklyDays)&&
        Objects.equals(this.additionalProperties, meetingsGetDetailsResponseRecurrence.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsGetDetailsResponseRecurrence {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsGetDetailsResponseRecurrence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsGetDetailsResponseRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsGetDetailsResponseRecurrence is not found in the empty JSON string", MeetingsGetDetailsResponseRecurrence.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MeetingsGetDetailsResponseRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsGetDetailsResponseRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsGetDetailsResponseRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsGetDetailsResponseRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsGetDetailsResponseRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsGetDetailsResponseRecurrence>() {
           @Override
           public void write(JsonWriter out, MeetingsGetDetailsResponseRecurrence value) throws IOException {
           ...
           @Override
           public MeetingsGetDetailsResponseRecurrence read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsGetDetailsResponseRecurrence instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsGetDetailsResponseRecurrence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsGetDetailsResponseRecurrence
  * @throws IOException if the JSON string is invalid with respect to MeetingsGetDetailsResponseRecurrence
  */
  public static MeetingsGetDetailsResponseRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsGetDetailsResponseRecurrence.class);
  }

 /**
  * Convert an instance of MeetingsGetDetailsResponseRecurrence to an JSON string
  *
  * @return JSON string
  */
