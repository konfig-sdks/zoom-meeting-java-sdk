...
public class ArchivingMeetingFilesList200ResponseArchiveFilesInner {
 ...
 public enum StorageLocationEnum {
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner() {
  }

  public ArchivingMeetingFilesList200ResponseArchiveFilesInner downloadUrl(String downloadUrl) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner fileExtension(String fileExtension) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner filePath(String filePath) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner fileSize(Integer fileSize) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner fileType(FileTypeEnum fileType) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner id(String id) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner individual(Boolean individual) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner participantEmail(String participantEmail) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner participantJoinTime(OffsetDateTime participantJoinTime) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2021-03-12T02:07:27Z", required = true, value = "The join time for the generated recording file. If this value is returned when the individual value is true, then it is the recording file's participant join time. When the individual value is false, it returns the join time for the archiving gateway.")
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner participantLeaveTime(OffsetDateTime participantLeaveTime) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2021-03-12T02:12:27Z", required = true, value = "The leave time for the generated recording file. If this value is returned when the individual value is true, then it is the recording file's participant leave time. When the individual value is false, it returns the leave time for the archiving gateway.")
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner recordingType(RecordingTypeEnum recordingType) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner status(StatusEnum status) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner encryptionFingerprint(String encryptionFingerprint) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner numberOfMessages(Integer numberOfMessages) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner storageLocation(StorageLocationEnum storageLocation) {
  ...
  **/
  ...
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner autoDelete(Boolean autoDelete) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to auto delete the archived file.   **Prerequisites:**   * The \"Tag Archiving Files for Deletion\" feature must be enabled in OP. Contact [Zoom Support](https://support.zoom.us/hc/en-us/articles/201362003) to open. ")
   ...
   * @return the ArchivingMeetingFilesList200ResponseArchiveFilesInner instance itself
   */
  public ArchivingMeetingFilesList200ResponseArchiveFilesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ArchivingMeetingFilesList200ResponseArchiveFilesInner archivingMeetingFilesList200ResponseArchiveFilesInner = (ArchivingMeetingFilesList200ResponseArchiveFilesInner) o;
    return Objects.equals(this.downloadUrl, archivingMeetingFilesList200ResponseArchiveFilesInner.downloadUrl) &&
        Objects.equals(this.fileExtension, archivingMeetingFilesList200ResponseArchiveFilesInner.fileExtension) &&
        Objects.equals(this.filePath, archivingMeetingFilesList200ResponseArchiveFilesInner.filePath) &&
        Objects.equals(this.fileSize, archivingMeetingFilesList200ResponseArchiveFilesInner.fileSize) &&
        Objects.equals(this.fileType, archivingMeetingFilesList200ResponseArchiveFilesInner.fileType) &&
        Objects.equals(this.id, archivingMeetingFilesList200ResponseArchiveFilesInner.id) &&
        Objects.equals(this.individual, archivingMeetingFilesList200ResponseArchiveFilesInner.individual) &&
        Objects.equals(this.participantEmail, archivingMeetingFilesList200ResponseArchiveFilesInner.participantEmail) &&
        Objects.equals(this.participantJoinTime, archivingMeetingFilesList200ResponseArchiveFilesInner.participantJoinTime) &&
        Objects.equals(this.participantLeaveTime, archivingMeetingFilesList200ResponseArchiveFilesInner.participantLeaveTime) &&
        Objects.equals(this.recordingType, archivingMeetingFilesList200ResponseArchiveFilesInner.recordingType) &&
        Objects.equals(this.status, archivingMeetingFilesList200ResponseArchiveFilesInner.status) &&
        Objects.equals(this.encryptionFingerprint, archivingMeetingFilesList200ResponseArchiveFilesInner.encryptionFingerprint) &&
        Objects.equals(this.numberOfMessages, archivingMeetingFilesList200ResponseArchiveFilesInner.numberOfMessages) &&
        Objects.equals(this.storageLocation, archivingMeetingFilesList200ResponseArchiveFilesInner.storageLocation) &&
        Objects.equals(this.autoDelete, archivingMeetingFilesList200ResponseArchiveFilesInner.autoDelete)&&
        Objects.equals(this.additionalProperties, archivingMeetingFilesList200ResponseArchiveFilesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArchivingMeetingFilesList200ResponseArchiveFilesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ArchivingMeetingFilesList200ResponseArchiveFilesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ArchivingMeetingFilesList200ResponseArchiveFilesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArchivingMeetingFilesList200ResponseArchiveFilesInner is not found in the empty JSON string", ArchivingMeetingFilesList200ResponseArchiveFilesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ArchivingMeetingFilesList200ResponseArchiveFilesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArchivingMeetingFilesList200ResponseArchiveFilesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArchivingMeetingFilesList200ResponseArchiveFilesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArchivingMeetingFilesList200ResponseArchiveFilesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArchivingMeetingFilesList200ResponseArchiveFilesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ArchivingMeetingFilesList200ResponseArchiveFilesInner>() {
           @Override
           public void write(JsonWriter out, ArchivingMeetingFilesList200ResponseArchiveFilesInner value) throws IOException {
           ...
           @Override
           public ArchivingMeetingFilesList200ResponseArchiveFilesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ArchivingMeetingFilesList200ResponseArchiveFilesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ArchivingMeetingFilesList200ResponseArchiveFilesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ArchivingMeetingFilesList200ResponseArchiveFilesInner
  * @throws IOException if the JSON string is invalid with respect to ArchivingMeetingFilesList200ResponseArchiveFilesInner
  */
  public static ArchivingMeetingFilesList200ResponseArchiveFilesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArchivingMeetingFilesList200ResponseArchiveFilesInner.class);
  }

 /**
  * Convert an instance of ArchivingMeetingFilesList200ResponseArchiveFilesInner to an JSON string
  *
  * @return JSON string
  */
