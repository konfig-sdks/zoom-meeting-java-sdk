 ...
 */
@ApiModel(description = "Recurrence object. Use this object only for a meeting with type `8`, a recurring meeting with fixed time. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebinarsUpdateScheduledWebinarRequestRecurrence {
 ...
 public enum WeeklyDaysEnum {
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence() {
  }

  public WebinarsUpdateScheduledWebinarRequestRecurrence endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence endTimes(Integer endTimes) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence repeatInterval(Integer repeatInterval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Define the interval when the meeting should recur. If you would like to schedule a meeting that recurs every two months, set the value of this field as `2` and the value of the `type` parameter as `3`.   For a daily meeting, the maximum interval you can set is `90` days. For a weekly meeting the maximum interval that you can set is  of `12` weeks. For a monthly meeting, there is a maximum of `3` months.  ")
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence type(TypeEnum type) {
  ...
  **/
  ...
  public WebinarsUpdateScheduledWebinarRequestRecurrence weeklyDays(WeeklyDaysEnum weeklyDays) {
  ...
  **/
   ...
   * @return the WebinarsUpdateScheduledWebinarRequestRecurrence instance itself
   */
  public WebinarsUpdateScheduledWebinarRequestRecurrence putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsUpdateScheduledWebinarRequestRecurrence webinarsUpdateScheduledWebinarRequestRecurrence = (WebinarsUpdateScheduledWebinarRequestRecurrence) o;
    return Objects.equals(this.endDateTime, webinarsUpdateScheduledWebinarRequestRecurrence.endDateTime) &&
        Objects.equals(this.endTimes, webinarsUpdateScheduledWebinarRequestRecurrence.endTimes) &&
        Objects.equals(this.monthlyDay, webinarsUpdateScheduledWebinarRequestRecurrence.monthlyDay) &&
        Objects.equals(this.monthlyWeek, webinarsUpdateScheduledWebinarRequestRecurrence.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, webinarsUpdateScheduledWebinarRequestRecurrence.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, webinarsUpdateScheduledWebinarRequestRecurrence.repeatInterval) &&
        Objects.equals(this.type, webinarsUpdateScheduledWebinarRequestRecurrence.type) &&
        Objects.equals(this.weeklyDays, webinarsUpdateScheduledWebinarRequestRecurrence.weeklyDays)&&
        Objects.equals(this.additionalProperties, webinarsUpdateScheduledWebinarRequestRecurrence.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsUpdateScheduledWebinarRequestRecurrence {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsUpdateScheduledWebinarRequestRecurrence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsUpdateScheduledWebinarRequestRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsUpdateScheduledWebinarRequestRecurrence is not found in the empty JSON string", WebinarsUpdateScheduledWebinarRequestRecurrence.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebinarsUpdateScheduledWebinarRequestRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsUpdateScheduledWebinarRequestRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsUpdateScheduledWebinarRequestRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsUpdateScheduledWebinarRequestRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsUpdateScheduledWebinarRequestRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsUpdateScheduledWebinarRequestRecurrence>() {
           @Override
           public void write(JsonWriter out, WebinarsUpdateScheduledWebinarRequestRecurrence value) throws IOException {
           ...
           @Override
           public WebinarsUpdateScheduledWebinarRequestRecurrence read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsUpdateScheduledWebinarRequestRecurrence instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsUpdateScheduledWebinarRequestRecurrence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsUpdateScheduledWebinarRequestRecurrence
  * @throws IOException if the JSON string is invalid with respect to WebinarsUpdateScheduledWebinarRequestRecurrence
  */
  public static WebinarsUpdateScheduledWebinarRequestRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsUpdateScheduledWebinarRequestRecurrence.class);
  }

 /**
  * Convert an instance of WebinarsUpdateScheduledWebinarRequestRecurrence to an JSON string
  *
  * @return JSON string
  */
