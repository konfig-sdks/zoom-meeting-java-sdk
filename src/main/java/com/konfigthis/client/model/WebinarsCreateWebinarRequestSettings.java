...
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification;
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification;
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification;
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsLanguageInterpretation;
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsQuestionAndAnswer;
import com.konfigthis.client.model.WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation;
 ...
 */
@ApiModel(description = "Create webinar settings.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebinarsCreateWebinarRequestSettings {
 ...
 public enum ApprovalTypeEnum {
  ...
  private WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification attendeesAndPanelistsReminderEmailNotification;
 ...
 public enum AutoRecordingEnum {
  ...
  private WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification followUpAbsenteesEmailNotification;
  ...
  private WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification followUpAttendeesEmailNotification;
  ...
  private WebinarsCreateWebinarRequestSettingsLanguageInterpretation languageInterpretation;
  ...
  private WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation signLanguageInterpretation;
  ...
  private WebinarsCreateWebinarRequestSettingsQuestionAndAnswer questionAndAnswer;
 ...
 public enum RegistrationTypeEnum {
  ...
  public WebinarsCreateWebinarRequestSettings() {
  }

  public WebinarsCreateWebinarRequestSettings allowMultipleDevices(Boolean allowMultipleDevices) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings alternativeHosts(String alternativeHosts) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jchill@example.com;thill@example.com", value = "Alternative host emails or IDs. Multiple values separated by comma.")
  ...
  public WebinarsCreateWebinarRequestSettings alternativeHostUpdatePolls(Boolean alternativeHostUpdatePolls) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings approvalType(ApprovalTypeEnum approvalType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_0", value = "The default value is `2`. To enable registration required, set the approval type to `0` or `1`.  Values include:      `0` - Automatically approve.    `1` - Manually approve.    `2` - No registration required.")
  ...
  public WebinarsCreateWebinarRequestSettings attendeesAndPanelistsReminderEmailNotification(WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification attendeesAndPanelistsReminderEmailNotification) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification getAttendeesAndPanelistsReminderEmailNotification() {
    return attendeesAndPanelistsReminderEmailNotification;
  }


  public void setAttendeesAndPanelistsReminderEmailNotification(WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification attendeesAndPanelistsReminderEmailNotification) {
  ...
  public WebinarsCreateWebinarRequestSettings audio(AudioEnum audio) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TELEPHONY", value = "Determine how participants can join the audio portion of the meeting.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettings audioConferenceInfo(String audioConferenceInfo) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings authenticationDomains(String authenticationDomains) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example.com", value = "Meeting authentication domains. This option allows you to specify the rule so that Zoom users whose email address contains a certain domain can join the webinar. You can either provide multiple comma-separated domains, use a wildcard for listing domains, or use both methods.")
  ...
  public WebinarsCreateWebinarRequestSettings authenticationOption(String authenticationOption) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "signIn_D8cJuqWVQ623CI4Q8yQK0Q", value = "Specify the authentication type for users to join a Webinar with`meeting_authentication` setting set to `true`. The value of this field can be retrieved from the `id` field within `authentication_options` array in the response of [**Get user settings**](https://developers.zoom.us/docs/api/rest/reference/zoom-api/methods#operation/userSettings) API.")
  ...
  public WebinarsCreateWebinarRequestSettings autoRecording(AutoRecordingEnum autoRecording) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CLOUD", value = "Automatic recording. Not supported for simulive webinar.     `local` - Record on local.    `cloud` -  Record on cloud.    `none` - Disabled.")
  ...
  public WebinarsCreateWebinarRequestSettings closeRegistration(Boolean closeRegistration) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings contactEmail(String contactEmail) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings contactName(String contactName) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings emailLanguage(String emailLanguage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "en-US", value = "Set the email language. `en-US`,`de-DE`,`es-ES`,`fr-FR`,`id-ID`,`jp-JP`,`nl-NL`,`pl-PL`,`pt-PT`,`ru-RU`,`tr-TR`,`zh-CN`, `zh-TW`, `ko-KO`, `it-IT`, `vi-VN`.")
  ...
  public WebinarsCreateWebinarRequestSettings enforceLogin(Boolean enforceLogin) {
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Only signed-in users can join this meeting.   **This field is deprecated and will not be supported in future.**          Instead of this field, use the `meeting_authentication`, `authentication_option`, or `authentication_domains` fields to establish the authentication mechanism for this Webinar. ")
  ...
  public WebinarsCreateWebinarRequestSettings enforceLoginDomains(String enforceLoginDomains) {
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example.com", value = "Only signed-in users with specified domains can join meetings.  **This field is deprecated and will not be supported in future.**        Instead of this field, use the `authentication_domains` field for this webinar. ")
  ...
  public WebinarsCreateWebinarRequestSettings followUpAbsenteesEmailNotification(WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification followUpAbsenteesEmailNotification) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification getFollowUpAbsenteesEmailNotification() {
    return followUpAbsenteesEmailNotification;
  }


  public void setFollowUpAbsenteesEmailNotification(WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification followUpAbsenteesEmailNotification) {
  ...
  public WebinarsCreateWebinarRequestSettings followUpAttendeesEmailNotification(WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification followUpAttendeesEmailNotification) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification getFollowUpAttendeesEmailNotification() {
    return followUpAttendeesEmailNotification;
  }


  public void setFollowUpAttendeesEmailNotification(WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification followUpAttendeesEmailNotification) {
  ...
  public WebinarsCreateWebinarRequestSettings globalDialInCountries(List<String> globalDialInCountries) {
  ...
  public WebinarsCreateWebinarRequestSettings addGlobalDialInCountriesItem(String globalDialInCountriesItem) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings hdVideo(Boolean hdVideo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Default to HD video.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettings hdVideoForAttendees(Boolean hdVideoForAttendees) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether HD video for attendees is enabled. This value defaults to `false`.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettings hostVideo(Boolean hostVideo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Start video when host joins webinar.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettings languageInterpretation(WebinarsCreateWebinarRequestSettingsLanguageInterpretation languageInterpretation) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsLanguageInterpretation getLanguageInterpretation() {
    return languageInterpretation;
  }


  public void setLanguageInterpretation(WebinarsCreateWebinarRequestSettingsLanguageInterpretation languageInterpretation) {
  ...
  public WebinarsCreateWebinarRequestSettings signLanguageInterpretation(WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation signLanguageInterpretation) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation getSignLanguageInterpretation() {
    return signLanguageInterpretation;
  }


  public void setSignLanguageInterpretation(WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation signLanguageInterpretation) {
  ...
  public WebinarsCreateWebinarRequestSettings panelistAuthentication(Boolean panelistAuthentication) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings meetingAuthentication(Boolean meetingAuthentication) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Only [authenticated](https://support.zoom.us/hc/en-us/articles/360037117472-Authentication-Profiles-for-Meetings-and-Webinars) users can join meeting if the value of this field is set to `true`.")
  ...
  public WebinarsCreateWebinarRequestSettings addWatermark(Boolean addWatermark) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Add watermark that identifies the viewing participant. Not supported for simulive webinar.")
  ...
  public WebinarsCreateWebinarRequestSettings addAudioWatermark(Boolean addAudioWatermark) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Add audio watermark that identifies the participants. Not supported for simulive webinar.")
  ...
  public WebinarsCreateWebinarRequestSettings onDemand(Boolean onDemand) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Make the webinar on-demand. Not supported for simulive webinar.")
  ...
  public WebinarsCreateWebinarRequestSettings panelistsInvitationEmailNotification(Boolean panelistsInvitationEmailNotification) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings panelistsVideo(Boolean panelistsVideo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Start video when panelists join webinar. Not supported for simulive webinar.")
  ...
  public WebinarsCreateWebinarRequestSettings postWebinarSurvey(Boolean postWebinarSurvey) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings practiceSession(Boolean practiceSession) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings questionAndAnswer(WebinarsCreateWebinarRequestSettingsQuestionAndAnswer questionAndAnswer) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer getQuestionAndAnswer() {
    return questionAndAnswer;
  }


  public void setQuestionAndAnswer(WebinarsCreateWebinarRequestSettingsQuestionAndAnswer questionAndAnswer) {
  ...
  public WebinarsCreateWebinarRequestSettings registrantsEmailNotification(Boolean registrantsEmailNotification) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings registrantsRestrictNumber(Integer registrantsRestrictNumber) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings registrationType(RegistrationTypeEnum registrationType) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings send1080pVideoToAttendees(Boolean send1080pVideoToAttendees) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether to always send 1080p video to attendees. This value defaults to `false`.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettings showShareButton(Boolean showShareButton) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings surveyUrl(String surveyUrl) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettings enableSessionBranding(Boolean enableSessionBranding) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether the **Webinar Session Branding** setting is enabled. This setting lets hosts visually customize a webinar by setting a session background. This also lets hosts set Virtual Background and apply name tags to hosts, alternative hosts, panelists, interpreters, and speakers.")
   ...
   * @return the WebinarsCreateWebinarRequestSettings instance itself
   */
  public WebinarsCreateWebinarRequestSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsCreateWebinarRequestSettings webinarsCreateWebinarRequestSettings = (WebinarsCreateWebinarRequestSettings) o;
    return Objects.equals(this.allowMultipleDevices, webinarsCreateWebinarRequestSettings.allowMultipleDevices) &&
        Objects.equals(this.alternativeHosts, webinarsCreateWebinarRequestSettings.alternativeHosts) &&
        Objects.equals(this.alternativeHostUpdatePolls, webinarsCreateWebinarRequestSettings.alternativeHostUpdatePolls) &&
        Objects.equals(this.approvalType, webinarsCreateWebinarRequestSettings.approvalType) &&
        Objects.equals(this.attendeesAndPanelistsReminderEmailNotification, webinarsCreateWebinarRequestSettings.attendeesAndPanelistsReminderEmailNotification) &&
        Objects.equals(this.audio, webinarsCreateWebinarRequestSettings.audio) &&
        Objects.equals(this.audioConferenceInfo, webinarsCreateWebinarRequestSettings.audioConferenceInfo) &&
        Objects.equals(this.authenticationDomains, webinarsCreateWebinarRequestSettings.authenticationDomains) &&
        Objects.equals(this.authenticationOption, webinarsCreateWebinarRequestSettings.authenticationOption) &&
        Objects.equals(this.autoRecording, webinarsCreateWebinarRequestSettings.autoRecording) &&
        Objects.equals(this.closeRegistration, webinarsCreateWebinarRequestSettings.closeRegistration) &&
        Objects.equals(this.contactEmail, webinarsCreateWebinarRequestSettings.contactEmail) &&
        Objects.equals(this.contactName, webinarsCreateWebinarRequestSettings.contactName) &&
        Objects.equals(this.emailLanguage, webinarsCreateWebinarRequestSettings.emailLanguage) &&
        Objects.equals(this.enforceLogin, webinarsCreateWebinarRequestSettings.enforceLogin) &&
        Objects.equals(this.enforceLoginDomains, webinarsCreateWebinarRequestSettings.enforceLoginDomains) &&
        Objects.equals(this.followUpAbsenteesEmailNotification, webinarsCreateWebinarRequestSettings.followUpAbsenteesEmailNotification) &&
        Objects.equals(this.followUpAttendeesEmailNotification, webinarsCreateWebinarRequestSettings.followUpAttendeesEmailNotification) &&
        Objects.equals(this.globalDialInCountries, webinarsCreateWebinarRequestSettings.globalDialInCountries) &&
        Objects.equals(this.hdVideo, webinarsCreateWebinarRequestSettings.hdVideo) &&
        Objects.equals(this.hdVideoForAttendees, webinarsCreateWebinarRequestSettings.hdVideoForAttendees) &&
        Objects.equals(this.hostVideo, webinarsCreateWebinarRequestSettings.hostVideo) &&
        Objects.equals(this.languageInterpretation, webinarsCreateWebinarRequestSettings.languageInterpretation) &&
        Objects.equals(this.signLanguageInterpretation, webinarsCreateWebinarRequestSettings.signLanguageInterpretation) &&
        Objects.equals(this.panelistAuthentication, webinarsCreateWebinarRequestSettings.panelistAuthentication) &&
        Objects.equals(this.meetingAuthentication, webinarsCreateWebinarRequestSettings.meetingAuthentication) &&
        Objects.equals(this.addWatermark, webinarsCreateWebinarRequestSettings.addWatermark) &&
        Objects.equals(this.addAudioWatermark, webinarsCreateWebinarRequestSettings.addAudioWatermark) &&
        Objects.equals(this.onDemand, webinarsCreateWebinarRequestSettings.onDemand) &&
        Objects.equals(this.panelistsInvitationEmailNotification, webinarsCreateWebinarRequestSettings.panelistsInvitationEmailNotification) &&
        Objects.equals(this.panelistsVideo, webinarsCreateWebinarRequestSettings.panelistsVideo) &&
        Objects.equals(this.postWebinarSurvey, webinarsCreateWebinarRequestSettings.postWebinarSurvey) &&
        Objects.equals(this.practiceSession, webinarsCreateWebinarRequestSettings.practiceSession) &&
        Objects.equals(this.questionAndAnswer, webinarsCreateWebinarRequestSettings.questionAndAnswer) &&
        Objects.equals(this.registrantsEmailNotification, webinarsCreateWebinarRequestSettings.registrantsEmailNotification) &&
        Objects.equals(this.registrantsRestrictNumber, webinarsCreateWebinarRequestSettings.registrantsRestrictNumber) &&
        Objects.equals(this.registrationType, webinarsCreateWebinarRequestSettings.registrationType) &&
        Objects.equals(this.send1080pVideoToAttendees, webinarsCreateWebinarRequestSettings.send1080pVideoToAttendees) &&
        Objects.equals(this.showShareButton, webinarsCreateWebinarRequestSettings.showShareButton) &&
        Objects.equals(this.surveyUrl, webinarsCreateWebinarRequestSettings.surveyUrl) &&
        Objects.equals(this.enableSessionBranding, webinarsCreateWebinarRequestSettings.enableSessionBranding)&&
        Objects.equals(this.additionalProperties, webinarsCreateWebinarRequestSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowMultipleDevices, alternativeHosts, alternativeHostUpdatePolls, approvalType, attendeesAndPanelistsReminderEmailNotification, audio, audioConferenceInfo, authenticationDomains, authenticationOption, autoRecording, closeRegistration, contactEmail, contactName, emailLanguage, enforceLogin, enforceLoginDomains, followUpAbsenteesEmailNotification, followUpAttendeesEmailNotification, globalDialInCountries, hdVideo, hdVideoForAttendees, hostVideo, languageInterpretation, signLanguageInterpretation, panelistAuthentication, meetingAuthentication, addWatermark, addAudioWatermark, onDemand, panelistsInvitationEmailNotification, panelistsVideo, postWebinarSurvey, practiceSession, questionAndAnswer, registrantsEmailNotification, registrantsRestrictNumber, registrationType, send1080pVideoToAttendees, showShareButton, surveyUrl, enableSessionBranding, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebinarsCreateWebinarRequestSettings {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsCreateWebinarRequestSettings
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsCreateWebinarRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsCreateWebinarRequestSettings is not found in the empty JSON string", WebinarsCreateWebinarRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("attendees_and_panelists_reminder_email_notification") != null && !jsonObj.get("attendees_and_panelists_reminder_email_notification").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsAttendeesAndPanelistsReminderEmailNotification.validateJsonObject(jsonObj.getAsJsonObject("attendees_and_panelists_reminder_email_notification"));
      }
      ...
      if (jsonObj.get("follow_up_absentees_email_notification") != null && !jsonObj.get("follow_up_absentees_email_notification").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsFollowUpAbsenteesEmailNotification.validateJsonObject(jsonObj.getAsJsonObject("follow_up_absentees_email_notification"));
      }
      ...
      if (jsonObj.get("follow_up_attendees_email_notification") != null && !jsonObj.get("follow_up_attendees_email_notification").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsFollowUpAttendeesEmailNotification.validateJsonObject(jsonObj.getAsJsonObject("follow_up_attendees_email_notification"));
      }
      ...
      if (jsonObj.get("language_interpretation") != null && !jsonObj.get("language_interpretation").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsLanguageInterpretation.validateJsonObject(jsonObj.getAsJsonObject("language_interpretation"));
      }
      ...
      if (jsonObj.get("sign_language_interpretation") != null && !jsonObj.get("sign_language_interpretation").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsSignLanguageInterpretation.validateJsonObject(jsonObj.getAsJsonObject("sign_language_interpretation"));
      }
      ...
      if (jsonObj.get("question_and_answer") != null && !jsonObj.get("question_and_answer").isJsonNull()) {
        WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.validateJsonObject(jsonObj.getAsJsonObject("question_and_answer"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsCreateWebinarRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsCreateWebinarRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsCreateWebinarRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsCreateWebinarRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsCreateWebinarRequestSettings>() {
           @Override
           public void write(JsonWriter out, WebinarsCreateWebinarRequestSettings value) throws IOException {
           ...
           @Override
           public WebinarsCreateWebinarRequestSettings read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsCreateWebinarRequestSettings instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsCreateWebinarRequestSettings given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsCreateWebinarRequestSettings
  * @throws IOException if the JSON string is invalid with respect to WebinarsCreateWebinarRequestSettings
  */
  public static WebinarsCreateWebinarRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsCreateWebinarRequestSettings.class);
  }

 /**
  * Convert an instance of WebinarsCreateWebinarRequestSettings to an JSON string
  *
  * @return JSON string
  */
