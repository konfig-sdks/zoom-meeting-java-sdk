...
public class SipPhoneListResponsePhonesInner {
 ...
 public enum TransportProtocol3Enum {
  ...
  public SipPhoneListResponsePhonesInner() {
  }

  public SipPhoneListResponsePhonesInner authorizationName(String authorizationName) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner domain(String domain) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example.com", value = "The name or IP address of your provider's SIP domain.")
  ...
  public SipPhoneListResponsePhonesInner id(String id) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner password(String password) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "apassword1", value = "The password generated for the user in the SIP account. ")
  ...
  public SipPhoneListResponsePhonesInner proxyServer(String proxyServer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "192.0.2.2", value = "The IP address of the proxy server for SIP requests. Note that if you are using the UDP transport protocol, the default port is 5060. If you are using UDP with a different port number, that port number must be included with the IP address. If you are not using a proxy server, this value can be the same as the Register Server, or empty.")
  ...
  public SipPhoneListResponsePhonesInner proxyServer2(String proxyServer2) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner proxyServer3(String proxyServer3) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner registerServer(String registerServer) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner registerServer2(String registerServer2) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner registerServer3(String registerServer3) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner registrationExpireTime(Integer registrationExpireTime) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner transportProtocol(TransportProtocolEnum transportProtocol) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner transportProtocol2(TransportProtocol2Enum transportProtocol2) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner transportProtocol3(TransportProtocol3Enum transportProtocol3) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner userEmail(String userEmail) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner userName(String userName) {
  ...
  **/
  ...
  public SipPhoneListResponsePhonesInner voiceMail(String voiceMail) {
  ...
  **/
   ...
   * @return the SipPhoneListResponsePhonesInner instance itself
   */
  public SipPhoneListResponsePhonesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SipPhoneListResponsePhonesInner sipPhoneListResponsePhonesInner = (SipPhoneListResponsePhonesInner) o;
    return Objects.equals(this.authorizationName, sipPhoneListResponsePhonesInner.authorizationName) &&
        Objects.equals(this.domain, sipPhoneListResponsePhonesInner.domain) &&
        Objects.equals(this.id, sipPhoneListResponsePhonesInner.id) &&
        Objects.equals(this.password, sipPhoneListResponsePhonesInner.password) &&
        Objects.equals(this.proxyServer, sipPhoneListResponsePhonesInner.proxyServer) &&
        Objects.equals(this.proxyServer2, sipPhoneListResponsePhonesInner.proxyServer2) &&
        Objects.equals(this.proxyServer3, sipPhoneListResponsePhonesInner.proxyServer3) &&
        Objects.equals(this.registerServer, sipPhoneListResponsePhonesInner.registerServer) &&
        Objects.equals(this.registerServer2, sipPhoneListResponsePhonesInner.registerServer2) &&
        Objects.equals(this.registerServer3, sipPhoneListResponsePhonesInner.registerServer3) &&
        Objects.equals(this.registrationExpireTime, sipPhoneListResponsePhonesInner.registrationExpireTime) &&
        Objects.equals(this.transportProtocol, sipPhoneListResponsePhonesInner.transportProtocol) &&
        Objects.equals(this.transportProtocol2, sipPhoneListResponsePhonesInner.transportProtocol2) &&
        Objects.equals(this.transportProtocol3, sipPhoneListResponsePhonesInner.transportProtocol3) &&
        Objects.equals(this.userEmail, sipPhoneListResponsePhonesInner.userEmail) &&
        Objects.equals(this.userName, sipPhoneListResponsePhonesInner.userName) &&
        Objects.equals(this.voiceMail, sipPhoneListResponsePhonesInner.voiceMail)&&
        Objects.equals(this.additionalProperties, sipPhoneListResponsePhonesInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationName, domain, id, password, proxyServer, proxyServer2, proxyServer3, registerServer, registerServer2, registerServer3, registrationExpireTime, transportProtocol, transportProtocol2, transportProtocol3, userEmail, userName, voiceMail, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SipPhoneListResponsePhonesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SipPhoneListResponsePhonesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SipPhoneListResponsePhonesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SipPhoneListResponsePhonesInner is not found in the empty JSON string", SipPhoneListResponsePhonesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SipPhoneListResponsePhonesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SipPhoneListResponsePhonesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SipPhoneListResponsePhonesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SipPhoneListResponsePhonesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SipPhoneListResponsePhonesInner>() {
           @Override
           public void write(JsonWriter out, SipPhoneListResponsePhonesInner value) throws IOException {
           ...
           @Override
           public SipPhoneListResponsePhonesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SipPhoneListResponsePhonesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SipPhoneListResponsePhonesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SipPhoneListResponsePhonesInner
  * @throws IOException if the JSON string is invalid with respect to SipPhoneListResponsePhonesInner
  */
  public static SipPhoneListResponsePhonesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SipPhoneListResponsePhonesInner.class);
  }

 /**
  * Convert an instance of SipPhoneListResponsePhonesInner to an JSON string
  *
  * @return JSON string
  */
