...
public class WebinarsCreateWebinarResponseSettingsQuestionAndAnswer {
 ...
 public enum AnswerQuestionsEnum {
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer() {
  }

  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer allowSubmitQuestions(Boolean allowSubmitQuestions) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer allowAnonymousQuestions(Boolean allowAnonymousQuestions) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer answerQuestions(AnswerQuestionsEnum answerQuestions) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer attendeesCanComment(Boolean attendeesCanComment) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer attendeesCanUpvote(Boolean attendeesCanUpvote) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer allowAutoReply(Boolean allowAutoReply) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer autoReplyText(String autoReplyText) {
  ...
  **/
  ...
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer enable(Boolean enable) {
  ...
  **/
   ...
   * @return the WebinarsCreateWebinarResponseSettingsQuestionAndAnswer instance itself
   */
  public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsCreateWebinarResponseSettingsQuestionAndAnswer webinarsCreateWebinarResponseSettingsQuestionAndAnswer = (WebinarsCreateWebinarResponseSettingsQuestionAndAnswer) o;
    return Objects.equals(this.allowSubmitQuestions, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.allowSubmitQuestions) &&
        Objects.equals(this.allowAnonymousQuestions, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.allowAnonymousQuestions) &&
        Objects.equals(this.answerQuestions, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.answerQuestions) &&
        Objects.equals(this.attendeesCanComment, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.attendeesCanComment) &&
        Objects.equals(this.attendeesCanUpvote, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.attendeesCanUpvote) &&
        Objects.equals(this.allowAutoReply, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.allowAutoReply) &&
        Objects.equals(this.autoReplyText, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.autoReplyText) &&
        Objects.equals(this.enable, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.enable)&&
        Objects.equals(this.additionalProperties, webinarsCreateWebinarResponseSettingsQuestionAndAnswer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsCreateWebinarResponseSettingsQuestionAndAnswer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsCreateWebinarResponseSettingsQuestionAndAnswer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsCreateWebinarResponseSettingsQuestionAndAnswer is not found in the empty JSON string", WebinarsCreateWebinarResponseSettingsQuestionAndAnswer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsCreateWebinarResponseSettingsQuestionAndAnswer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsCreateWebinarResponseSettingsQuestionAndAnswer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsCreateWebinarResponseSettingsQuestionAndAnswer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsCreateWebinarResponseSettingsQuestionAndAnswer.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsCreateWebinarResponseSettingsQuestionAndAnswer>() {
           @Override
           public void write(JsonWriter out, WebinarsCreateWebinarResponseSettingsQuestionAndAnswer value) throws IOException {
           ...
           @Override
           public WebinarsCreateWebinarResponseSettingsQuestionAndAnswer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsCreateWebinarResponseSettingsQuestionAndAnswer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsCreateWebinarResponseSettingsQuestionAndAnswer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
  * @throws IOException if the JSON string is invalid with respect to WebinarsCreateWebinarResponseSettingsQuestionAndAnswer
  */
  public static WebinarsCreateWebinarResponseSettingsQuestionAndAnswer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsCreateWebinarResponseSettingsQuestionAndAnswer.class);
  }

 /**
  * Convert an instance of WebinarsCreateWebinarResponseSettingsQuestionAndAnswer to an JSON string
  *
  * @return JSON string
  */
