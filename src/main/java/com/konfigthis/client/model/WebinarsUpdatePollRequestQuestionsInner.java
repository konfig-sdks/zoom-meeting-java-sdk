...
import com.konfigthis.client.model.WebinarsUpdatePollRequestQuestionsInnerPromptsInner;
...
public class WebinarsUpdatePollRequestQuestionsInner {
  ...
  private List<WebinarsUpdatePollRequestQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public WebinarsUpdatePollRequestQuestionsInner() {
  }

  public WebinarsUpdatePollRequestQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner answers(List<String> answers) {
  ...
  public WebinarsUpdatePollRequestQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner name(String name) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner prompts(List<WebinarsUpdatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsUpdatePollRequestQuestionsInner addPromptsItem(WebinarsUpdatePollRequestQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<WebinarsUpdatePollRequestQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<WebinarsUpdatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsUpdatePollRequestQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public WebinarsUpdatePollRequestQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public WebinarsUpdatePollRequestQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the WebinarsUpdatePollRequestQuestionsInner instance itself
   */
  public WebinarsUpdatePollRequestQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsUpdatePollRequestQuestionsInner webinarsUpdatePollRequestQuestionsInner = (WebinarsUpdatePollRequestQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, webinarsUpdatePollRequestQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, webinarsUpdatePollRequestQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, webinarsUpdatePollRequestQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, webinarsUpdatePollRequestQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, webinarsUpdatePollRequestQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, webinarsUpdatePollRequestQuestionsInner.name) &&
        Objects.equals(this.prompts, webinarsUpdatePollRequestQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, webinarsUpdatePollRequestQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, webinarsUpdatePollRequestQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, webinarsUpdatePollRequestQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, webinarsUpdatePollRequestQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, webinarsUpdatePollRequestQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, webinarsUpdatePollRequestQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, webinarsUpdatePollRequestQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, webinarsUpdatePollRequestQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsUpdatePollRequestQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsUpdatePollRequestQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsUpdatePollRequestQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsUpdatePollRequestQuestionsInner is not found in the empty JSON string", WebinarsUpdatePollRequestQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            WebinarsUpdatePollRequestQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsUpdatePollRequestQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsUpdatePollRequestQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsUpdatePollRequestQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsUpdatePollRequestQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsUpdatePollRequestQuestionsInner>() {
           @Override
           public void write(JsonWriter out, WebinarsUpdatePollRequestQuestionsInner value) throws IOException {
           ...
           @Override
           public WebinarsUpdatePollRequestQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsUpdatePollRequestQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsUpdatePollRequestQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsUpdatePollRequestQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to WebinarsUpdatePollRequestQuestionsInner
  */
  public static WebinarsUpdatePollRequestQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsUpdatePollRequestQuestionsInner.class);
  }

 /**
  * Convert an instance of WebinarsUpdatePollRequestQuestionsInner to an JSON string
  *
  * @return JSON string
  */
