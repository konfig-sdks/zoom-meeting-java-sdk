...
public class WebinarsGetDetailsResponseSettingsQuestionAndAnswer {
 ...
 public enum AnswerQuestionsEnum {
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer() {
  }

  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer allowSubmitQuestions(Boolean allowSubmitQuestions) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer allowAnonymousQuestions(Boolean allowAnonymousQuestions) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer answerQuestions(AnswerQuestionsEnum answerQuestions) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer attendeesCanComment(Boolean attendeesCanComment) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer attendeesCanUpvote(Boolean attendeesCanUpvote) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer allowAutoReply(Boolean allowAutoReply) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer autoReplyText(String autoReplyText) {
  ...
  **/
  ...
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer enable(Boolean enable) {
  ...
  **/
   ...
   * @return the WebinarsGetDetailsResponseSettingsQuestionAndAnswer instance itself
   */
  public WebinarsGetDetailsResponseSettingsQuestionAndAnswer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsGetDetailsResponseSettingsQuestionAndAnswer webinarsGetDetailsResponseSettingsQuestionAndAnswer = (WebinarsGetDetailsResponseSettingsQuestionAndAnswer) o;
    return Objects.equals(this.allowSubmitQuestions, webinarsGetDetailsResponseSettingsQuestionAndAnswer.allowSubmitQuestions) &&
        Objects.equals(this.allowAnonymousQuestions, webinarsGetDetailsResponseSettingsQuestionAndAnswer.allowAnonymousQuestions) &&
        Objects.equals(this.answerQuestions, webinarsGetDetailsResponseSettingsQuestionAndAnswer.answerQuestions) &&
        Objects.equals(this.attendeesCanComment, webinarsGetDetailsResponseSettingsQuestionAndAnswer.attendeesCanComment) &&
        Objects.equals(this.attendeesCanUpvote, webinarsGetDetailsResponseSettingsQuestionAndAnswer.attendeesCanUpvote) &&
        Objects.equals(this.allowAutoReply, webinarsGetDetailsResponseSettingsQuestionAndAnswer.allowAutoReply) &&
        Objects.equals(this.autoReplyText, webinarsGetDetailsResponseSettingsQuestionAndAnswer.autoReplyText) &&
        Objects.equals(this.enable, webinarsGetDetailsResponseSettingsQuestionAndAnswer.enable)&&
        Objects.equals(this.additionalProperties, webinarsGetDetailsResponseSettingsQuestionAndAnswer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsGetDetailsResponseSettingsQuestionAndAnswer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsGetDetailsResponseSettingsQuestionAndAnswer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsGetDetailsResponseSettingsQuestionAndAnswer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsGetDetailsResponseSettingsQuestionAndAnswer is not found in the empty JSON string", WebinarsGetDetailsResponseSettingsQuestionAndAnswer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsGetDetailsResponseSettingsQuestionAndAnswer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsGetDetailsResponseSettingsQuestionAndAnswer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsGetDetailsResponseSettingsQuestionAndAnswer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsGetDetailsResponseSettingsQuestionAndAnswer.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsGetDetailsResponseSettingsQuestionAndAnswer>() {
           @Override
           public void write(JsonWriter out, WebinarsGetDetailsResponseSettingsQuestionAndAnswer value) throws IOException {
           ...
           @Override
           public WebinarsGetDetailsResponseSettingsQuestionAndAnswer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsGetDetailsResponseSettingsQuestionAndAnswer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsGetDetailsResponseSettingsQuestionAndAnswer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsGetDetailsResponseSettingsQuestionAndAnswer
  * @throws IOException if the JSON string is invalid with respect to WebinarsGetDetailsResponseSettingsQuestionAndAnswer
  */
  public static WebinarsGetDetailsResponseSettingsQuestionAndAnswer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsGetDetailsResponseSettingsQuestionAndAnswer.class);
  }

 /**
  * Convert an instance of WebinarsGetDetailsResponseSettingsQuestionAndAnswer to an JSON string
  *
  * @return JSON string
  */
