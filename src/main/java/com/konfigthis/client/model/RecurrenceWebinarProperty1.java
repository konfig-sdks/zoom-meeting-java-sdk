...
public class RecurrenceWebinarProperty1 {
 ...
 public enum TypeEnum {
  ...
  public RecurrenceWebinarProperty1() {
  }

  public RecurrenceWebinarProperty1 endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-04-02T15:59Z", value = "Select a date when the webinar will recur before it is canceled. Should be in UTC time, such as 2017-11-25T12:00:00Z. Can't be used with `end_times`.")
  ...
  public RecurrenceWebinarProperty1 endTimes(Integer endTimes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7", value = "Select how many times the webinar will recur before it is canceled. The maximum number of recurring is 60. Can't be used with `end_date_time`.")
  ...
  public RecurrenceWebinarProperty1 monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty1 monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty1 monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty1 repeatInterval(Integer repeatInterval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Define the interval when the webinar should recur. For instance, if you would like to schedule a Webinar that recurs every two months, you must set the value of this field as `2` and the value of the `type` parameter as `3`.   For a daily webinar, the maximum interval you can set is `90` days. For a weekly webinar, the maximum interval that you can set is `12` weeks. For a monthly webinar, the maximum interval that you can set is `3` months.")
  ...
  public RecurrenceWebinarProperty1 type(TypeEnum type) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty1 weeklyDays(String weeklyDays) {
  ...
  **/
   ...
   * @return the RecurrenceWebinarProperty1 instance itself
   */
  public RecurrenceWebinarProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurrenceWebinarProperty1 recurrenceWebinarProperty1 = (RecurrenceWebinarProperty1) o;
    return Objects.equals(this.endDateTime, recurrenceWebinarProperty1.endDateTime) &&
        Objects.equals(this.endTimes, recurrenceWebinarProperty1.endTimes) &&
        Objects.equals(this.monthlyDay, recurrenceWebinarProperty1.monthlyDay) &&
        Objects.equals(this.monthlyWeek, recurrenceWebinarProperty1.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, recurrenceWebinarProperty1.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, recurrenceWebinarProperty1.repeatInterval) &&
        Objects.equals(this.type, recurrenceWebinarProperty1.type) &&
        Objects.equals(this.weeklyDays, recurrenceWebinarProperty1.weeklyDays)&&
        Objects.equals(this.additionalProperties, recurrenceWebinarProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurrenceWebinarProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurrenceWebinarProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurrenceWebinarProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurrenceWebinarProperty1 is not found in the empty JSON string", RecurrenceWebinarProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecurrenceWebinarProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurrenceWebinarProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurrenceWebinarProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurrenceWebinarProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurrenceWebinarProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurrenceWebinarProperty1>() {
           @Override
           public void write(JsonWriter out, RecurrenceWebinarProperty1 value) throws IOException {
           ...
           @Override
           public RecurrenceWebinarProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurrenceWebinarProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurrenceWebinarProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurrenceWebinarProperty1
  * @throws IOException if the JSON string is invalid with respect to RecurrenceWebinarProperty1
  */
  public static RecurrenceWebinarProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurrenceWebinarProperty1.class);
  }

 /**
  * Convert an instance of RecurrenceWebinarProperty1 to an JSON string
  *
  * @return JSON string
  */
