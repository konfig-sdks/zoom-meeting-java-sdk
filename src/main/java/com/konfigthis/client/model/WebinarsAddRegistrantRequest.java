 ...
 */
@ApiModel(description = "Information about the webinar registrant.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebinarsAddRegistrantRequest {
  ...
  private List<WebinarsAddRegistrantRequestCustomQuestionsInner> customQuestions = null;
 ...
 public enum LanguageEnum {
  ...
  public WebinarsAddRegistrantRequest() {
  }

  public WebinarsAddRegistrantRequest firstName(String firstName) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest lastName(String lastName) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest email(String email) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest address(String address) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest city(String city) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest state(String state) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest zip(String zip) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest country(String country) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest phone(String phone) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest comments(String comments) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest customQuestions(List<WebinarsAddRegistrantRequestCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsAddRegistrantRequest addCustomQuestionsItem(WebinarsAddRegistrantRequestCustomQuestionsInner customQuestionsItem) {
  ...
  **/
  ...
  public List<WebinarsAddRegistrantRequestCustomQuestionsInner> getCustomQuestions() {
    return customQuestions;
  }


  public void setCustomQuestions(List<WebinarsAddRegistrantRequestCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsAddRegistrantRequest industry(String industry) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest jobTitle(String jobTitle) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest noOfEmployees(NoOfEmployeesEnum noOfEmployees) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest org(String org) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest purchasingTimeFrame(PurchasingTimeFrameEnum purchasingTimeFrame) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest roleInPurchaseProcess(RoleInPurchaseProcessEnum roleInPurchaseProcess) {
  ...
  **/
  ...
  public WebinarsAddRegistrantRequest language(LanguageEnum language) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EN_US", value = "The registrant's language preference for confirmation emails:  * `en-US` - English (US)  * `de-DE` - German (Germany)  * `es-ES` - Spanish (Spain)  * `fr-FR` - French (France)  * `jp-JP` - Japanese  * `pt-PT` - Portuguese (Portugal)  * `ru-RU` - Russian  * `zh-CN` - Chinese (PRC)  * `zh-TW` - Chinese (Taiwan)  * `ko-KO` - Korean  * `it-IT` - Italian (Italy)  * `vi-VN` - Vietnamese  * `pl-PL` - Polish  * `Tr-TR` - Turkish")
  ...
  public WebinarsAddRegistrantRequest sourceId(String sourceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4816766181770", value = "The tracking source's unique identifier.")
   ...
   * @return the WebinarsAddRegistrantRequest instance itself
   */
  public WebinarsAddRegistrantRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsAddRegistrantRequest webinarsAddRegistrantRequest = (WebinarsAddRegistrantRequest) o;
    return Objects.equals(this.firstName, webinarsAddRegistrantRequest.firstName) &&
        Objects.equals(this.lastName, webinarsAddRegistrantRequest.lastName) &&
        Objects.equals(this.email, webinarsAddRegistrantRequest.email) &&
        Objects.equals(this.address, webinarsAddRegistrantRequest.address) &&
        Objects.equals(this.city, webinarsAddRegistrantRequest.city) &&
        Objects.equals(this.state, webinarsAddRegistrantRequest.state) &&
        Objects.equals(this.zip, webinarsAddRegistrantRequest.zip) &&
        Objects.equals(this.country, webinarsAddRegistrantRequest.country) &&
        Objects.equals(this.phone, webinarsAddRegistrantRequest.phone) &&
        Objects.equals(this.comments, webinarsAddRegistrantRequest.comments) &&
        Objects.equals(this.customQuestions, webinarsAddRegistrantRequest.customQuestions) &&
        Objects.equals(this.industry, webinarsAddRegistrantRequest.industry) &&
        Objects.equals(this.jobTitle, webinarsAddRegistrantRequest.jobTitle) &&
        Objects.equals(this.noOfEmployees, webinarsAddRegistrantRequest.noOfEmployees) &&
        Objects.equals(this.org, webinarsAddRegistrantRequest.org) &&
        Objects.equals(this.purchasingTimeFrame, webinarsAddRegistrantRequest.purchasingTimeFrame) &&
        Objects.equals(this.roleInPurchaseProcess, webinarsAddRegistrantRequest.roleInPurchaseProcess) &&
        Objects.equals(this.language, webinarsAddRegistrantRequest.language) &&
        Objects.equals(this.sourceId, webinarsAddRegistrantRequest.sourceId)&&
        Objects.equals(this.additionalProperties, webinarsAddRegistrantRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, email, address, city, state, zip, country, phone, comments, customQuestions, industry, jobTitle, noOfEmployees, org, purchasingTimeFrame, roleInPurchaseProcess, language, sourceId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebinarsAddRegistrantRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsAddRegistrantRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsAddRegistrantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsAddRegistrantRequest is not found in the empty JSON string", WebinarsAddRegistrantRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebinarsAddRegistrantRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("custom_questions") != null && !jsonObj.get("custom_questions").isJsonNull()) {
        ...
        if (jsonArraycustomQuestions != null) {
          ...
          for (int i = 0; i < jsonArraycustomQuestions.size(); i++) {
            WebinarsAddRegistrantRequestCustomQuestionsInner.validateJsonObject(jsonArraycustomQuestions.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsAddRegistrantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsAddRegistrantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsAddRegistrantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsAddRegistrantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsAddRegistrantRequest>() {
           @Override
           public void write(JsonWriter out, WebinarsAddRegistrantRequest value) throws IOException {
           ...
           @Override
           public WebinarsAddRegistrantRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsAddRegistrantRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsAddRegistrantRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsAddRegistrantRequest
  * @throws IOException if the JSON string is invalid with respect to WebinarsAddRegistrantRequest
  */
  public static WebinarsAddRegistrantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsAddRegistrantRequest.class);
  }

 /**
  * Convert an instance of WebinarsAddRegistrantRequest to an JSON string
  *
  * @return JSON string
  */
