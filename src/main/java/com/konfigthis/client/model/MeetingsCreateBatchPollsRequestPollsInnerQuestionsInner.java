...
import com.konfigthis.client.model.MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner;
...
public class MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner {
  ...
  private List<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner() {
  }

  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "How useful was this meeting?", value = "The poll question's title, up to 255 characters.   For `fill_in_the_blank` polls, this field is the poll's question. For each value that the user must fill in, ensure that there are the same number of `right_answers` values.")
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner prompts(List<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner addPromptsItem(MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner ratingMinValue(Integer ratingMinValue) {
    if (ratingMinValue != null && ratingMinValue < 1) {
      throw new IllegalArgumentException("Invalid value for ratingMinValue. Must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The rating scale's minimum value. This value cannot be less than zero.   This field only applies to the `rating_scale` poll.")
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner instance itself
   */
  public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner meetingsCreateBatchPollsRequestPollsInnerQuestionsInner = (MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.name) &&
        Objects.equals(this.prompts, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingsCreateBatchPollsRequestPollsInnerQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner is not found in the empty JSON string", MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsCreateBatchPollsRequestPollsInnerQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner
  */
  public static MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsCreateBatchPollsRequestPollsInnerQuestionsInner to an JSON string
  *
  * @return JSON string
  */
