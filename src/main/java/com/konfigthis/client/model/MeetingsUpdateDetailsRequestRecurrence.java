...
public class MeetingsUpdateDetailsRequestRecurrence {
 ...
 public enum WeeklyDaysEnum {
  ...
  public MeetingsUpdateDetailsRequestRecurrence() {
  }

  public MeetingsUpdateDetailsRequestRecurrence endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-04-02T15:59Z", value = "Select the final date when the meeting recurs before it is canceled. Should be in UTC time, such as 2017-11-25T12:00:00Z. Cannot be used with `end_times`.")
  ...
  public MeetingsUpdateDetailsRequestRecurrence endTimes(Integer endTimes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7", value = "Select how many times the meeting should recur before it is canceled. If `end_times` is set to 0, it means there is no end time. The maximum number of recurrences is 60. Cannot be used with `end_date_time`.")
  ...
  public MeetingsUpdateDetailsRequestRecurrence monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public MeetingsUpdateDetailsRequestRecurrence monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public MeetingsUpdateDetailsRequestRecurrence monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public MeetingsUpdateDetailsRequestRecurrence repeatInterval(Integer repeatInterval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Define the interval when the meeting should recur. For instance, to schedule a meeting that recurs every two months, set this field's value as `2` and the `type` parameter's value to `3`.   For a daily meeting, the maximum interval is `90` days. For a weekly meeting, the maximum interval is `12` weeks. For a monthly meeting, the maximum value is `3` months.  ")
  ...
  public MeetingsUpdateDetailsRequestRecurrence type(TypeEnum type) {
  ...
  **/
  ...
  public MeetingsUpdateDetailsRequestRecurrence weeklyDays(WeeklyDaysEnum weeklyDays) {
  ...
  **/
   ...
   * @return the MeetingsUpdateDetailsRequestRecurrence instance itself
   */
  public MeetingsUpdateDetailsRequestRecurrence putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsUpdateDetailsRequestRecurrence meetingsUpdateDetailsRequestRecurrence = (MeetingsUpdateDetailsRequestRecurrence) o;
    return Objects.equals(this.endDateTime, meetingsUpdateDetailsRequestRecurrence.endDateTime) &&
        Objects.equals(this.endTimes, meetingsUpdateDetailsRequestRecurrence.endTimes) &&
        Objects.equals(this.monthlyDay, meetingsUpdateDetailsRequestRecurrence.monthlyDay) &&
        Objects.equals(this.monthlyWeek, meetingsUpdateDetailsRequestRecurrence.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, meetingsUpdateDetailsRequestRecurrence.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, meetingsUpdateDetailsRequestRecurrence.repeatInterval) &&
        Objects.equals(this.type, meetingsUpdateDetailsRequestRecurrence.type) &&
        Objects.equals(this.weeklyDays, meetingsUpdateDetailsRequestRecurrence.weeklyDays)&&
        Objects.equals(this.additionalProperties, meetingsUpdateDetailsRequestRecurrence.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsUpdateDetailsRequestRecurrence {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsUpdateDetailsRequestRecurrence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsUpdateDetailsRequestRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsUpdateDetailsRequestRecurrence is not found in the empty JSON string", MeetingsUpdateDetailsRequestRecurrence.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MeetingsUpdateDetailsRequestRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsUpdateDetailsRequestRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsUpdateDetailsRequestRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsUpdateDetailsRequestRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsUpdateDetailsRequestRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsUpdateDetailsRequestRecurrence>() {
           @Override
           public void write(JsonWriter out, MeetingsUpdateDetailsRequestRecurrence value) throws IOException {
           ...
           @Override
           public MeetingsUpdateDetailsRequestRecurrence read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsUpdateDetailsRequestRecurrence instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsUpdateDetailsRequestRecurrence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsUpdateDetailsRequestRecurrence
  * @throws IOException if the JSON string is invalid with respect to MeetingsUpdateDetailsRequestRecurrence
  */
  public static MeetingsUpdateDetailsRequestRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsUpdateDetailsRequestRecurrence.class);
  }

 /**
  * Convert an instance of MeetingsUpdateDetailsRequestRecurrence to an JSON string
  *
  * @return JSON string
  */
