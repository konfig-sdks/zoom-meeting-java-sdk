...
import com.konfigthis.client.model.MeetingsCreatePollResponseQuestionsInnerPromptsInner;
...
public class MeetingsCreatePollResponseQuestionsInner {
  ...
  private List<MeetingsCreatePollResponseQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingsCreatePollResponseQuestionsInner() {
  }

  public MeetingsCreatePollResponseQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsCreatePollResponseQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner prompts(List<MeetingsCreatePollResponseQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreatePollResponseQuestionsInner addPromptsItem(MeetingsCreatePollResponseQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsCreatePollResponseQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsCreatePollResponseQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreatePollResponseQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingsCreatePollResponseQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsCreatePollResponseQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingsCreatePollResponseQuestionsInner instance itself
   */
  public MeetingsCreatePollResponseQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsCreatePollResponseQuestionsInner meetingsCreatePollResponseQuestionsInner = (MeetingsCreatePollResponseQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingsCreatePollResponseQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingsCreatePollResponseQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingsCreatePollResponseQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingsCreatePollResponseQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingsCreatePollResponseQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingsCreatePollResponseQuestionsInner.name) &&
        Objects.equals(this.prompts, meetingsCreatePollResponseQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingsCreatePollResponseQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingsCreatePollResponseQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsCreatePollResponseQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingsCreatePollResponseQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingsCreatePollResponseQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingsCreatePollResponseQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingsCreatePollResponseQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingsCreatePollResponseQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsCreatePollResponseQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsCreatePollResponseQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsCreatePollResponseQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsCreatePollResponseQuestionsInner is not found in the empty JSON string", MeetingsCreatePollResponseQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsCreatePollResponseQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsCreatePollResponseQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsCreatePollResponseQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsCreatePollResponseQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsCreatePollResponseQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsCreatePollResponseQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsCreatePollResponseQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsCreatePollResponseQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsCreatePollResponseQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsCreatePollResponseQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsCreatePollResponseQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsCreatePollResponseQuestionsInner
  */
  public static MeetingsCreatePollResponseQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsCreatePollResponseQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsCreatePollResponseQuestionsInner to an JSON string
  *
  * @return JSON string
  */
