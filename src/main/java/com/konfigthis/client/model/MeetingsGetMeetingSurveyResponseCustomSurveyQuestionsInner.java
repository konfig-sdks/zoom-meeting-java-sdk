...
public class MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner {
 ...
 public enum TypeEnum {
  ...
  private List<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner> prompts = null;
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner() {
  }

  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "How useful was this meeting?", value = "The survey question, up to 420 characters.")
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner type(TypeEnum type) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner prompts(List<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner addPromptsItem(MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
   ...
   * @return the MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner instance itself
   */
  public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner = (MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner) o;
    return Objects.equals(this.name, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.name) &&
        Objects.equals(this.type, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.type) &&
        Objects.equals(this.answerRequired, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.answerRequired) &&
        Objects.equals(this.showAsDropdown, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.showAsDropdown) &&
        Objects.equals(this.answers, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.answers) &&
        Objects.equals(this.prompts, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.prompts) &&
        Objects.equals(this.answerMinCharacter, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerMaxCharacter, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.ratingMinValue, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.ratingMinValue) &&
        Objects.equals(this.ratingMaxValue, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMaxLabel, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.ratingMaxLabel)&&
        Objects.equals(this.additionalProperties, meetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner is not found in the empty JSON string", MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner
  */
  public static MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsGetMeetingSurveyResponseCustomSurveyQuestionsInner to an JSON string
  *
  * @return JSON string
  */
