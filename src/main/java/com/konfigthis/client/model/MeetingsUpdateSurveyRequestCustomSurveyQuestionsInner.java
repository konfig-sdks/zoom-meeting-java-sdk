...
public class MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner {
 ...
 public enum TypeEnum {
  ...
  private List<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner> prompts = null;
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner() {
  }

  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner type(TypeEnum type) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner prompts(List<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner addPromptsItem(MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
   ...
   * @return the MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner instance itself
   */
  public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner meetingsUpdateSurveyRequestCustomSurveyQuestionsInner = (MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner) o;
    return Objects.equals(this.name, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.name) &&
        Objects.equals(this.type, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.type) &&
        Objects.equals(this.answerRequired, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.answerRequired) &&
        Objects.equals(this.showAsDropdown, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.showAsDropdown) &&
        Objects.equals(this.answers, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.answers) &&
        Objects.equals(this.prompts, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.prompts) &&
        Objects.equals(this.answerMinCharacter, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerMaxCharacter, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.ratingMinValue, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.ratingMinValue) &&
        Objects.equals(this.ratingMaxValue, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMaxLabel, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.ratingMaxLabel)&&
        Objects.equals(this.additionalProperties, meetingsUpdateSurveyRequestCustomSurveyQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner is not found in the empty JSON string", MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsUpdateSurveyRequestCustomSurveyQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner
  */
  public static MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsUpdateSurveyRequestCustomSurveyQuestionsInner to an JSON string
  *
  * @return JSON string
  */
