...
public class WebinarsCreateWebinarRequestSettingsQuestionAndAnswer {
 ...
 public enum AnswerQuestionsEnum {
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer() {
  }

  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer allowSubmitQuestions(Boolean allowSubmitQuestions) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer allowAnonymousQuestions(Boolean allowAnonymousQuestions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "* `true` - Allow participants to send questions without providing their name to the host, co-host, and panelists..  * `false` - Do not allow anonymous questions.(Not supported for simulive webinar.)")
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer answerQuestions(AnswerQuestionsEnum answerQuestions) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer attendeesCanComment(Boolean attendeesCanComment) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "* `true` - Attendees can answer questions or leave a comment in the question thread.  * `false` - Attendees can not answer questions or leave a comment in the question thread")
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer attendeesCanUpvote(Boolean attendeesCanUpvote) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "* `true` - Attendees can click the thumbs up button to bring popular questions to the top of the Q&amp;A window.  * `false` - Attendees can not click the thumbs up button on questions.")
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer allowAutoReply(Boolean allowAutoReply) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer autoReplyText(String autoReplyText) {
  ...
  **/
  ...
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer enable(Boolean enable) {
  ...
  **/
   ...
   * @return the WebinarsCreateWebinarRequestSettingsQuestionAndAnswer instance itself
   */
  public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsCreateWebinarRequestSettingsQuestionAndAnswer webinarsCreateWebinarRequestSettingsQuestionAndAnswer = (WebinarsCreateWebinarRequestSettingsQuestionAndAnswer) o;
    return Objects.equals(this.allowSubmitQuestions, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.allowSubmitQuestions) &&
        Objects.equals(this.allowAnonymousQuestions, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.allowAnonymousQuestions) &&
        Objects.equals(this.answerQuestions, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.answerQuestions) &&
        Objects.equals(this.attendeesCanComment, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.attendeesCanComment) &&
        Objects.equals(this.attendeesCanUpvote, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.attendeesCanUpvote) &&
        Objects.equals(this.allowAutoReply, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.allowAutoReply) &&
        Objects.equals(this.autoReplyText, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.autoReplyText) &&
        Objects.equals(this.enable, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.enable)&&
        Objects.equals(this.additionalProperties, webinarsCreateWebinarRequestSettingsQuestionAndAnswer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsCreateWebinarRequestSettingsQuestionAndAnswer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsCreateWebinarRequestSettingsQuestionAndAnswer is not found in the empty JSON string", WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsCreateWebinarRequestSettingsQuestionAndAnswer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsCreateWebinarRequestSettingsQuestionAndAnswer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsCreateWebinarRequestSettingsQuestionAndAnswer>() {
           @Override
           public void write(JsonWriter out, WebinarsCreateWebinarRequestSettingsQuestionAndAnswer value) throws IOException {
           ...
           @Override
           public WebinarsCreateWebinarRequestSettingsQuestionAndAnswer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsCreateWebinarRequestSettingsQuestionAndAnswer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsCreateWebinarRequestSettingsQuestionAndAnswer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
  * @throws IOException if the JSON string is invalid with respect to WebinarsCreateWebinarRequestSettingsQuestionAndAnswer
  */
  public static WebinarsCreateWebinarRequestSettingsQuestionAndAnswer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsCreateWebinarRequestSettingsQuestionAndAnswer.class);
  }

 /**
  * Convert an instance of WebinarsCreateWebinarRequestSettingsQuestionAndAnswer to an JSON string
  *
  * @return JSON string
  */
