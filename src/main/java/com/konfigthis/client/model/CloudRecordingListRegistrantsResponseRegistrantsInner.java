...
import com.konfigthis.client.model.CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner;
...
public class CloudRecordingListRegistrantsResponseRegistrantsInner {
  ...
  private List<CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions = null;
 ...
 public enum StatusEnum {
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner() {
  }

  public CloudRecordingListRegistrantsResponseRegistrantsInner id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "3Z7sEm0TQQieLav3c3OD_g", value = "The registrant's ID.")
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner address(String address) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner city(String city) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner comments(String comments) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner country(String country) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner customQuestions(List<CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner addCustomQuestionsItem(CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner customQuestionsItem) {
  ...
  **/
  ...
  public List<CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> getCustomQuestions() {
    return customQuestions;
  }


  public void setCustomQuestions(List<CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner email(String email) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner firstName(String firstName) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner industry(String industry) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner jobTitle(String jobTitle) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner lastName(String lastName) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner noOfEmployees(NoOfEmployeesEnum noOfEmployees) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner org(String org) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner phone(String phone) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner purchasingTimeFrame(PurchasingTimeFrameEnum purchasingTimeFrame) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner roleInPurchaseProcess(RoleInPurchaseProcessEnum roleInPurchaseProcess) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner state(String state) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner status(StatusEnum status) {
  ...
  **/
  ...
  public CloudRecordingListRegistrantsResponseRegistrantsInner zip(String zip) {
  ...
  **/
   ...
   * @return the CloudRecordingListRegistrantsResponseRegistrantsInner instance itself
   */
  public CloudRecordingListRegistrantsResponseRegistrantsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CloudRecordingListRegistrantsResponseRegistrantsInner cloudRecordingListRegistrantsResponseRegistrantsInner = (CloudRecordingListRegistrantsResponseRegistrantsInner) o;
    return Objects.equals(this.id, cloudRecordingListRegistrantsResponseRegistrantsInner.id) &&
        Objects.equals(this.address, cloudRecordingListRegistrantsResponseRegistrantsInner.address) &&
        Objects.equals(this.city, cloudRecordingListRegistrantsResponseRegistrantsInner.city) &&
        Objects.equals(this.comments, cloudRecordingListRegistrantsResponseRegistrantsInner.comments) &&
        Objects.equals(this.country, cloudRecordingListRegistrantsResponseRegistrantsInner.country) &&
        Objects.equals(this.customQuestions, cloudRecordingListRegistrantsResponseRegistrantsInner.customQuestions) &&
        Objects.equals(this.email, cloudRecordingListRegistrantsResponseRegistrantsInner.email) &&
        Objects.equals(this.firstName, cloudRecordingListRegistrantsResponseRegistrantsInner.firstName) &&
        Objects.equals(this.industry, cloudRecordingListRegistrantsResponseRegistrantsInner.industry) &&
        Objects.equals(this.jobTitle, cloudRecordingListRegistrantsResponseRegistrantsInner.jobTitle) &&
        Objects.equals(this.lastName, cloudRecordingListRegistrantsResponseRegistrantsInner.lastName) &&
        Objects.equals(this.noOfEmployees, cloudRecordingListRegistrantsResponseRegistrantsInner.noOfEmployees) &&
        Objects.equals(this.org, cloudRecordingListRegistrantsResponseRegistrantsInner.org) &&
        Objects.equals(this.phone, cloudRecordingListRegistrantsResponseRegistrantsInner.phone) &&
        Objects.equals(this.purchasingTimeFrame, cloudRecordingListRegistrantsResponseRegistrantsInner.purchasingTimeFrame) &&
        Objects.equals(this.roleInPurchaseProcess, cloudRecordingListRegistrantsResponseRegistrantsInner.roleInPurchaseProcess) &&
        Objects.equals(this.state, cloudRecordingListRegistrantsResponseRegistrantsInner.state) &&
        Objects.equals(this.status, cloudRecordingListRegistrantsResponseRegistrantsInner.status) &&
        Objects.equals(this.zip, cloudRecordingListRegistrantsResponseRegistrantsInner.zip)&&
        Objects.equals(this.additionalProperties, cloudRecordingListRegistrantsResponseRegistrantsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, address, city, comments, country, customQuestions, email, firstName, industry, jobTitle, lastName, noOfEmployees, org, phone, purchasingTimeFrame, roleInPurchaseProcess, state, status, zip, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CloudRecordingListRegistrantsResponseRegistrantsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CloudRecordingListRegistrantsResponseRegistrantsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CloudRecordingListRegistrantsResponseRegistrantsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudRecordingListRegistrantsResponseRegistrantsInner is not found in the empty JSON string", CloudRecordingListRegistrantsResponseRegistrantsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudRecordingListRegistrantsResponseRegistrantsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("custom_questions") != null && !jsonObj.get("custom_questions").isJsonNull()) {
        ...
        if (jsonArraycustomQuestions != null) {
          ...
          for (int i = 0; i < jsonArraycustomQuestions.size(); i++) {
            CloudRecordingListRegistrantsResponseRegistrantsInnerCustomQuestionsInner.validateJsonObject(jsonArraycustomQuestions.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudRecordingListRegistrantsResponseRegistrantsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudRecordingListRegistrantsResponseRegistrantsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudRecordingListRegistrantsResponseRegistrantsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudRecordingListRegistrantsResponseRegistrantsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudRecordingListRegistrantsResponseRegistrantsInner>() {
           @Override
           public void write(JsonWriter out, CloudRecordingListRegistrantsResponseRegistrantsInner value) throws IOException {
           ...
           @Override
           public CloudRecordingListRegistrantsResponseRegistrantsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CloudRecordingListRegistrantsResponseRegistrantsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CloudRecordingListRegistrantsResponseRegistrantsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CloudRecordingListRegistrantsResponseRegistrantsInner
  * @throws IOException if the JSON string is invalid with respect to CloudRecordingListRegistrantsResponseRegistrantsInner
  */
  public static CloudRecordingListRegistrantsResponseRegistrantsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudRecordingListRegistrantsResponseRegistrantsInner.class);
  }

 /**
  * Convert an instance of CloudRecordingListRegistrantsResponseRegistrantsInner to an JSON string
  *
  * @return JSON string
  */
