 ...
 */
@ApiModel(description = "Recurrence object. Use this object only for a webinar of type `9`, a recurring webinar with fixed time. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RecurrenceWebinarProperty {
 ...
 public enum TypeEnum {
  ...
  public RecurrenceWebinarProperty() {
  }

  public RecurrenceWebinarProperty endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty endTimes(Integer endTimes) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty repeatInterval(Integer repeatInterval) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty type(TypeEnum type) {
  ...
  **/
  ...
  public RecurrenceWebinarProperty weeklyDays(String weeklyDays) {
  ...
  **/
   ...
   * @return the RecurrenceWebinarProperty instance itself
   */
  public RecurrenceWebinarProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurrenceWebinarProperty recurrenceWebinarProperty = (RecurrenceWebinarProperty) o;
    return Objects.equals(this.endDateTime, recurrenceWebinarProperty.endDateTime) &&
        Objects.equals(this.endTimes, recurrenceWebinarProperty.endTimes) &&
        Objects.equals(this.monthlyDay, recurrenceWebinarProperty.monthlyDay) &&
        Objects.equals(this.monthlyWeek, recurrenceWebinarProperty.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, recurrenceWebinarProperty.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, recurrenceWebinarProperty.repeatInterval) &&
        Objects.equals(this.type, recurrenceWebinarProperty.type) &&
        Objects.equals(this.weeklyDays, recurrenceWebinarProperty.weeklyDays)&&
        Objects.equals(this.additionalProperties, recurrenceWebinarProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurrenceWebinarProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurrenceWebinarProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurrenceWebinarProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurrenceWebinarProperty is not found in the empty JSON string", RecurrenceWebinarProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecurrenceWebinarProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurrenceWebinarProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurrenceWebinarProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurrenceWebinarProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurrenceWebinarProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurrenceWebinarProperty>() {
           @Override
           public void write(JsonWriter out, RecurrenceWebinarProperty value) throws IOException {
           ...
           @Override
           public RecurrenceWebinarProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurrenceWebinarProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurrenceWebinarProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurrenceWebinarProperty
  * @throws IOException if the JSON string is invalid with respect to RecurrenceWebinarProperty
  */
  public static RecurrenceWebinarProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurrenceWebinarProperty.class);
  }

 /**
  * Convert an instance of RecurrenceWebinarProperty to an JSON string
  *
  * @return JSON string
  */
