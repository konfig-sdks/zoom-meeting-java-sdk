...
import com.konfigthis.client.model.MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner;
...
public class MeetingsUpdateMeetingPollRequestQuestionsInner {
  ...
  private List<MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner() {
  }

  public MeetingsUpdateMeetingPollRequestQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner prompts(List<MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner addPromptsItem(MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsUpdateMeetingPollRequestQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingsUpdateMeetingPollRequestQuestionsInner instance itself
   */
  public MeetingsUpdateMeetingPollRequestQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsUpdateMeetingPollRequestQuestionsInner meetingsUpdateMeetingPollRequestQuestionsInner = (MeetingsUpdateMeetingPollRequestQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingsUpdateMeetingPollRequestQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingsUpdateMeetingPollRequestQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingsUpdateMeetingPollRequestQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingsUpdateMeetingPollRequestQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingsUpdateMeetingPollRequestQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingsUpdateMeetingPollRequestQuestionsInner.name) &&
        Objects.equals(this.prompts, meetingsUpdateMeetingPollRequestQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingsUpdateMeetingPollRequestQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingsUpdateMeetingPollRequestQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsUpdateMeetingPollRequestQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingsUpdateMeetingPollRequestQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingsUpdateMeetingPollRequestQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingsUpdateMeetingPollRequestQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingsUpdateMeetingPollRequestQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingsUpdateMeetingPollRequestQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsUpdateMeetingPollRequestQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsUpdateMeetingPollRequestQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsUpdateMeetingPollRequestQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsUpdateMeetingPollRequestQuestionsInner is not found in the empty JSON string", MeetingsUpdateMeetingPollRequestQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsUpdateMeetingPollRequestQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsUpdateMeetingPollRequestQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsUpdateMeetingPollRequestQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsUpdateMeetingPollRequestQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsUpdateMeetingPollRequestQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsUpdateMeetingPollRequestQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsUpdateMeetingPollRequestQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsUpdateMeetingPollRequestQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsUpdateMeetingPollRequestQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsUpdateMeetingPollRequestQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsUpdateMeetingPollRequestQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsUpdateMeetingPollRequestQuestionsInner
  */
  public static MeetingsUpdateMeetingPollRequestQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsUpdateMeetingPollRequestQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsUpdateMeetingPollRequestQuestionsInner to an JSON string
  *
  * @return JSON string
  */
