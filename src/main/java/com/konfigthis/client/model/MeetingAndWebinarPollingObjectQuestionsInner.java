...
import com.konfigthis.client.model.MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner;
...
public class MeetingAndWebinarPollingObjectQuestionsInner {
  ...
  private List<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner() {
  }

  public MeetingAndWebinarPollingObjectQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner answers(List<String> answers) {
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner prompts(List<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner addPromptsItem(MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObjectQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingAndWebinarPollingObjectQuestionsInner instance itself
   */
  public MeetingAndWebinarPollingObjectQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingAndWebinarPollingObjectQuestionsInner meetingAndWebinarPollingObjectQuestionsInner = (MeetingAndWebinarPollingObjectQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingAndWebinarPollingObjectQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingAndWebinarPollingObjectQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingAndWebinarPollingObjectQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingAndWebinarPollingObjectQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingAndWebinarPollingObjectQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingAndWebinarPollingObjectQuestionsInner.name) &&
        Objects.equals(this.prompts, meetingAndWebinarPollingObjectQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingAndWebinarPollingObjectQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingAndWebinarPollingObjectQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingAndWebinarPollingObjectQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingAndWebinarPollingObjectQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingAndWebinarPollingObjectQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingAndWebinarPollingObjectQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingAndWebinarPollingObjectQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingAndWebinarPollingObjectQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingAndWebinarPollingObjectQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingAndWebinarPollingObjectQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingAndWebinarPollingObjectQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingAndWebinarPollingObjectQuestionsInner is not found in the empty JSON string", MeetingAndWebinarPollingObjectQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingAndWebinarPollingObjectQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingAndWebinarPollingObjectQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingAndWebinarPollingObjectQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingAndWebinarPollingObjectQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingAndWebinarPollingObjectQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingAndWebinarPollingObjectQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingAndWebinarPollingObjectQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingAndWebinarPollingObjectQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingAndWebinarPollingObjectQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingAndWebinarPollingObjectQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingAndWebinarPollingObjectQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingAndWebinarPollingObjectQuestionsInner
  */
  public static MeetingAndWebinarPollingObjectQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingAndWebinarPollingObjectQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingAndWebinarPollingObjectQuestionsInner to an JSON string
  *
  * @return JSON string
  */
