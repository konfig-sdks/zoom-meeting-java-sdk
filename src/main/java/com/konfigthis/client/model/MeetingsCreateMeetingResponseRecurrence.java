...
public class MeetingsCreateMeetingResponseRecurrence {
 ...
 public enum WeeklyDaysEnum {
  ...
  public MeetingsCreateMeetingResponseRecurrence() {
  }

  public MeetingsCreateMeetingResponseRecurrence endDateTime(OffsetDateTime endDateTime) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence endTimes(Integer endTimes) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence monthlyDay(Integer monthlyDay) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence monthlyWeek(MonthlyWeekEnum monthlyWeek) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence monthlyWeekDay(MonthlyWeekDayEnum monthlyWeekDay) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence repeatInterval(Integer repeatInterval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Define the interval for the meeting to recur. For instance, to schedule a meeting that recurs every two months, set this field's value to `2` and the value of the `type` parameter as `3`.   For a daily meeting, the maximum interval you can set is `90` days. For a weekly meeting the maximum interval that you can set is  of `12` weeks. For a monthly meeting, there is a maximum of `3` months.  ")
  ...
  public MeetingsCreateMeetingResponseRecurrence type(TypeEnum type) {
  ...
  **/
  ...
  public MeetingsCreateMeetingResponseRecurrence weeklyDays(WeeklyDaysEnum weeklyDays) {
  ...
  **/
   ...
   * @return the MeetingsCreateMeetingResponseRecurrence instance itself
   */
  public MeetingsCreateMeetingResponseRecurrence putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsCreateMeetingResponseRecurrence meetingsCreateMeetingResponseRecurrence = (MeetingsCreateMeetingResponseRecurrence) o;
    return Objects.equals(this.endDateTime, meetingsCreateMeetingResponseRecurrence.endDateTime) &&
        Objects.equals(this.endTimes, meetingsCreateMeetingResponseRecurrence.endTimes) &&
        Objects.equals(this.monthlyDay, meetingsCreateMeetingResponseRecurrence.monthlyDay) &&
        Objects.equals(this.monthlyWeek, meetingsCreateMeetingResponseRecurrence.monthlyWeek) &&
        Objects.equals(this.monthlyWeekDay, meetingsCreateMeetingResponseRecurrence.monthlyWeekDay) &&
        Objects.equals(this.repeatInterval, meetingsCreateMeetingResponseRecurrence.repeatInterval) &&
        Objects.equals(this.type, meetingsCreateMeetingResponseRecurrence.type) &&
        Objects.equals(this.weeklyDays, meetingsCreateMeetingResponseRecurrence.weeklyDays)&&
        Objects.equals(this.additionalProperties, meetingsCreateMeetingResponseRecurrence.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsCreateMeetingResponseRecurrence {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsCreateMeetingResponseRecurrence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsCreateMeetingResponseRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsCreateMeetingResponseRecurrence is not found in the empty JSON string", MeetingsCreateMeetingResponseRecurrence.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MeetingsCreateMeetingResponseRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsCreateMeetingResponseRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsCreateMeetingResponseRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsCreateMeetingResponseRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsCreateMeetingResponseRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsCreateMeetingResponseRecurrence>() {
           @Override
           public void write(JsonWriter out, MeetingsCreateMeetingResponseRecurrence value) throws IOException {
           ...
           @Override
           public MeetingsCreateMeetingResponseRecurrence read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsCreateMeetingResponseRecurrence instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsCreateMeetingResponseRecurrence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsCreateMeetingResponseRecurrence
  * @throws IOException if the JSON string is invalid with respect to MeetingsCreateMeetingResponseRecurrence
  */
  public static MeetingsCreateMeetingResponseRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsCreateMeetingResponseRecurrence.class);
  }

 /**
  * Convert an instance of MeetingsCreateMeetingResponseRecurrence to an JSON string
  *
  * @return JSON string
  */
