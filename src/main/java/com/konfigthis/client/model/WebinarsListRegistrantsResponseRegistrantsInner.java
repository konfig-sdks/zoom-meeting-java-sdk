...
import com.konfigthis.client.model.WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner;
...
public class WebinarsListRegistrantsResponseRegistrantsInner {
  ...
  private List<WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions = null;
 ...
 public enum StatusEnum {
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner() {
  }

  public WebinarsListRegistrantsResponseRegistrantsInner id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "9tboDiHUQAeOnbmudzWa5g", value = "Registrant ID.")
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner address(String address) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner city(String city) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner comments(String comments) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner country(String country) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner customQuestions(List<WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner addCustomQuestionsItem(WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner customQuestionsItem) {
  ...
  **/
  ...
  public List<WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> getCustomQuestions() {
    return customQuestions;
  }


  public void setCustomQuestions(List<WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner email(String email) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner firstName(String firstName) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner industry(String industry) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner jobTitle(String jobTitle) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner lastName(String lastName) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner noOfEmployees(NoOfEmployeesEnum noOfEmployees) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner org(String org) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner phone(String phone) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner purchasingTimeFrame(PurchasingTimeFrameEnum purchasingTimeFrame) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner roleInPurchaseProcess(RoleInPurchaseProcessEnum roleInPurchaseProcess) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner state(String state) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "APPROVED", value = "The status of the registrant's registration.      `approved` - User has been successfully approved for the webinar.     `pending` -  The registration is still pending.     `denied` - User has been denied from joining the webinar.")
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner zip(String zip) {
  ...
  **/
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner createTime(OffsetDateTime createTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-03-22T05:59:09Z", value = "The time when the registrant registered.")
  ...
  public WebinarsListRegistrantsResponseRegistrantsInner joinUrl(String joinUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://example.com/j/11111", value = "The URL that an approved registrant can use to join the meeting or webinar.")
   ...
   * @return the WebinarsListRegistrantsResponseRegistrantsInner instance itself
   */
  public WebinarsListRegistrantsResponseRegistrantsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsListRegistrantsResponseRegistrantsInner webinarsListRegistrantsResponseRegistrantsInner = (WebinarsListRegistrantsResponseRegistrantsInner) o;
    return Objects.equals(this.id, webinarsListRegistrantsResponseRegistrantsInner.id) &&
        Objects.equals(this.address, webinarsListRegistrantsResponseRegistrantsInner.address) &&
        Objects.equals(this.city, webinarsListRegistrantsResponseRegistrantsInner.city) &&
        Objects.equals(this.comments, webinarsListRegistrantsResponseRegistrantsInner.comments) &&
        Objects.equals(this.country, webinarsListRegistrantsResponseRegistrantsInner.country) &&
        Objects.equals(this.customQuestions, webinarsListRegistrantsResponseRegistrantsInner.customQuestions) &&
        Objects.equals(this.email, webinarsListRegistrantsResponseRegistrantsInner.email) &&
        Objects.equals(this.firstName, webinarsListRegistrantsResponseRegistrantsInner.firstName) &&
        Objects.equals(this.industry, webinarsListRegistrantsResponseRegistrantsInner.industry) &&
        Objects.equals(this.jobTitle, webinarsListRegistrantsResponseRegistrantsInner.jobTitle) &&
        Objects.equals(this.lastName, webinarsListRegistrantsResponseRegistrantsInner.lastName) &&
        Objects.equals(this.noOfEmployees, webinarsListRegistrantsResponseRegistrantsInner.noOfEmployees) &&
        Objects.equals(this.org, webinarsListRegistrantsResponseRegistrantsInner.org) &&
        Objects.equals(this.phone, webinarsListRegistrantsResponseRegistrantsInner.phone) &&
        Objects.equals(this.purchasingTimeFrame, webinarsListRegistrantsResponseRegistrantsInner.purchasingTimeFrame) &&
        Objects.equals(this.roleInPurchaseProcess, webinarsListRegistrantsResponseRegistrantsInner.roleInPurchaseProcess) &&
        Objects.equals(this.state, webinarsListRegistrantsResponseRegistrantsInner.state) &&
        Objects.equals(this.status, webinarsListRegistrantsResponseRegistrantsInner.status) &&
        Objects.equals(this.zip, webinarsListRegistrantsResponseRegistrantsInner.zip) &&
        Objects.equals(this.createTime, webinarsListRegistrantsResponseRegistrantsInner.createTime) &&
        Objects.equals(this.joinUrl, webinarsListRegistrantsResponseRegistrantsInner.joinUrl)&&
        Objects.equals(this.additionalProperties, webinarsListRegistrantsResponseRegistrantsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, address, city, comments, country, customQuestions, email, firstName, industry, jobTitle, lastName, noOfEmployees, org, phone, purchasingTimeFrame, roleInPurchaseProcess, state, status, zip, createTime, joinUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebinarsListRegistrantsResponseRegistrantsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsListRegistrantsResponseRegistrantsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsListRegistrantsResponseRegistrantsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsListRegistrantsResponseRegistrantsInner is not found in the empty JSON string", WebinarsListRegistrantsResponseRegistrantsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebinarsListRegistrantsResponseRegistrantsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("custom_questions") != null && !jsonObj.get("custom_questions").isJsonNull()) {
        ...
        if (jsonArraycustomQuestions != null) {
          ...
          for (int i = 0; i < jsonArraycustomQuestions.size(); i++) {
            WebinarsListRegistrantsResponseRegistrantsInnerCustomQuestionsInner.validateJsonObject(jsonArraycustomQuestions.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsListRegistrantsResponseRegistrantsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsListRegistrantsResponseRegistrantsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsListRegistrantsResponseRegistrantsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsListRegistrantsResponseRegistrantsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsListRegistrantsResponseRegistrantsInner>() {
           @Override
           public void write(JsonWriter out, WebinarsListRegistrantsResponseRegistrantsInner value) throws IOException {
           ...
           @Override
           public WebinarsListRegistrantsResponseRegistrantsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsListRegistrantsResponseRegistrantsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsListRegistrantsResponseRegistrantsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsListRegistrantsResponseRegistrantsInner
  * @throws IOException if the JSON string is invalid with respect to WebinarsListRegistrantsResponseRegistrantsInner
  */
  public static WebinarsListRegistrantsResponseRegistrantsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsListRegistrantsResponseRegistrantsInner.class);
  }

 /**
  * Convert an instance of WebinarsListRegistrantsResponseRegistrantsInner to an JSON string
  *
  * @return JSON string
  */
