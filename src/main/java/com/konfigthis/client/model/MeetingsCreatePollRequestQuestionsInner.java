...
import com.konfigthis.client.model.MeetingsCreatePollRequestQuestionsInnerPromptsInner;
...
public class MeetingsCreatePollRequestQuestionsInner {
  ...
  private List<MeetingsCreatePollRequestQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingsCreatePollRequestQuestionsInner() {
  }

  public MeetingsCreatePollRequestQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner answers(List<String> answers) {
  ...
  public MeetingsCreatePollRequestQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner prompts(List<MeetingsCreatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreatePollRequestQuestionsInner addPromptsItem(MeetingsCreatePollRequestQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingsCreatePollRequestQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingsCreatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingsCreatePollRequestQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingsCreatePollRequestQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingsCreatePollRequestQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingsCreatePollRequestQuestionsInner instance itself
   */
  public MeetingsCreatePollRequestQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingsCreatePollRequestQuestionsInner meetingsCreatePollRequestQuestionsInner = (MeetingsCreatePollRequestQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingsCreatePollRequestQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingsCreatePollRequestQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingsCreatePollRequestQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingsCreatePollRequestQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingsCreatePollRequestQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingsCreatePollRequestQuestionsInner.name) &&
        Objects.equals(this.prompts, meetingsCreatePollRequestQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingsCreatePollRequestQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingsCreatePollRequestQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingsCreatePollRequestQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingsCreatePollRequestQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingsCreatePollRequestQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingsCreatePollRequestQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingsCreatePollRequestQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingsCreatePollRequestQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingsCreatePollRequestQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingsCreatePollRequestQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingsCreatePollRequestQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingsCreatePollRequestQuestionsInner is not found in the empty JSON string", MeetingsCreatePollRequestQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingsCreatePollRequestQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingsCreatePollRequestQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingsCreatePollRequestQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingsCreatePollRequestQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingsCreatePollRequestQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingsCreatePollRequestQuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingsCreatePollRequestQuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingsCreatePollRequestQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingsCreatePollRequestQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingsCreatePollRequestQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingsCreatePollRequestQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingsCreatePollRequestQuestionsInner
  */
  public static MeetingsCreatePollRequestQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingsCreatePollRequestQuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingsCreatePollRequestQuestionsInner to an JSON string
  *
  * @return JSON string
  */
