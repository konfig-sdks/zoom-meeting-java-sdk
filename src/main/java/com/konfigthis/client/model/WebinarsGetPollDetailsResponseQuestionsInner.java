...
import com.konfigthis.client.model.WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner;
...
public class WebinarsGetPollDetailsResponseQuestionsInner {
  ...
  private List<WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner() {
  }

  public WebinarsGetPollDetailsResponseQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner answers(List<String> answers) {
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner name(String name) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner prompts(List<WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner addPromptsItem(WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public WebinarsGetPollDetailsResponseQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the WebinarsGetPollDetailsResponseQuestionsInner instance itself
   */
  public WebinarsGetPollDetailsResponseQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsGetPollDetailsResponseQuestionsInner webinarsGetPollDetailsResponseQuestionsInner = (WebinarsGetPollDetailsResponseQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, webinarsGetPollDetailsResponseQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, webinarsGetPollDetailsResponseQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, webinarsGetPollDetailsResponseQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, webinarsGetPollDetailsResponseQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, webinarsGetPollDetailsResponseQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, webinarsGetPollDetailsResponseQuestionsInner.name) &&
        Objects.equals(this.prompts, webinarsGetPollDetailsResponseQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, webinarsGetPollDetailsResponseQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, webinarsGetPollDetailsResponseQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, webinarsGetPollDetailsResponseQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, webinarsGetPollDetailsResponseQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, webinarsGetPollDetailsResponseQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, webinarsGetPollDetailsResponseQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, webinarsGetPollDetailsResponseQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, webinarsGetPollDetailsResponseQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsGetPollDetailsResponseQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsGetPollDetailsResponseQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsGetPollDetailsResponseQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsGetPollDetailsResponseQuestionsInner is not found in the empty JSON string", WebinarsGetPollDetailsResponseQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            WebinarsGetPollDetailsResponseQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsGetPollDetailsResponseQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsGetPollDetailsResponseQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsGetPollDetailsResponseQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsGetPollDetailsResponseQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsGetPollDetailsResponseQuestionsInner>() {
           @Override
           public void write(JsonWriter out, WebinarsGetPollDetailsResponseQuestionsInner value) throws IOException {
           ...
           @Override
           public WebinarsGetPollDetailsResponseQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsGetPollDetailsResponseQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsGetPollDetailsResponseQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsGetPollDetailsResponseQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to WebinarsGetPollDetailsResponseQuestionsInner
  */
  public static WebinarsGetPollDetailsResponseQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsGetPollDetailsResponseQuestionsInner.class);
  }

 /**
  * Convert an instance of WebinarsGetPollDetailsResponseQuestionsInner to an JSON string
  *
  * @return JSON string
  */
