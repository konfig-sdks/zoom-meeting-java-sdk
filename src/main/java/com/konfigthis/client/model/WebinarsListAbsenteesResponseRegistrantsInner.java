...
import com.konfigthis.client.model.WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner;
...
public class WebinarsListAbsenteesResponseRegistrantsInner {
  ...
  private List<WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner> customQuestions = null;
 ...
 public enum StatusEnum {
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner() {
  }

  public WebinarsListAbsenteesResponseRegistrantsInner id(String id) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner address(String address) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner city(String city) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner comments(String comments) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner country(String country) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner customQuestions(List<WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner addCustomQuestionsItem(WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner customQuestionsItem) {
  ...
  **/
  ...
  public List<WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner> getCustomQuestions() {
    return customQuestions;
  }


  public void setCustomQuestions(List<WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner> customQuestions) {
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner email(String email) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner firstName(String firstName) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner industry(String industry) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner jobTitle(String jobTitle) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner lastName(String lastName) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner noOfEmployees(NoOfEmployeesEnum noOfEmployees) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner org(String org) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner phone(String phone) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner purchasingTimeFrame(PurchasingTimeFrameEnum purchasingTimeFrame) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner roleInPurchaseProcess(RoleInPurchaseProcessEnum roleInPurchaseProcess) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner state(String state) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner status(StatusEnum status) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner zip(String zip) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner createTime(OffsetDateTime createTime) {
  ...
  **/
  ...
  public WebinarsListAbsenteesResponseRegistrantsInner joinUrl(String joinUrl) {
  ...
  **/
   ...
   * @return the WebinarsListAbsenteesResponseRegistrantsInner instance itself
   */
  public WebinarsListAbsenteesResponseRegistrantsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsListAbsenteesResponseRegistrantsInner webinarsListAbsenteesResponseRegistrantsInner = (WebinarsListAbsenteesResponseRegistrantsInner) o;
    return Objects.equals(this.id, webinarsListAbsenteesResponseRegistrantsInner.id) &&
        Objects.equals(this.address, webinarsListAbsenteesResponseRegistrantsInner.address) &&
        Objects.equals(this.city, webinarsListAbsenteesResponseRegistrantsInner.city) &&
        Objects.equals(this.comments, webinarsListAbsenteesResponseRegistrantsInner.comments) &&
        Objects.equals(this.country, webinarsListAbsenteesResponseRegistrantsInner.country) &&
        Objects.equals(this.customQuestions, webinarsListAbsenteesResponseRegistrantsInner.customQuestions) &&
        Objects.equals(this.email, webinarsListAbsenteesResponseRegistrantsInner.email) &&
        Objects.equals(this.firstName, webinarsListAbsenteesResponseRegistrantsInner.firstName) &&
        Objects.equals(this.industry, webinarsListAbsenteesResponseRegistrantsInner.industry) &&
        Objects.equals(this.jobTitle, webinarsListAbsenteesResponseRegistrantsInner.jobTitle) &&
        Objects.equals(this.lastName, webinarsListAbsenteesResponseRegistrantsInner.lastName) &&
        Objects.equals(this.noOfEmployees, webinarsListAbsenteesResponseRegistrantsInner.noOfEmployees) &&
        Objects.equals(this.org, webinarsListAbsenteesResponseRegistrantsInner.org) &&
        Objects.equals(this.phone, webinarsListAbsenteesResponseRegistrantsInner.phone) &&
        Objects.equals(this.purchasingTimeFrame, webinarsListAbsenteesResponseRegistrantsInner.purchasingTimeFrame) &&
        Objects.equals(this.roleInPurchaseProcess, webinarsListAbsenteesResponseRegistrantsInner.roleInPurchaseProcess) &&
        Objects.equals(this.state, webinarsListAbsenteesResponseRegistrantsInner.state) &&
        Objects.equals(this.status, webinarsListAbsenteesResponseRegistrantsInner.status) &&
        Objects.equals(this.zip, webinarsListAbsenteesResponseRegistrantsInner.zip) &&
        Objects.equals(this.createTime, webinarsListAbsenteesResponseRegistrantsInner.createTime) &&
        Objects.equals(this.joinUrl, webinarsListAbsenteesResponseRegistrantsInner.joinUrl)&&
        Objects.equals(this.additionalProperties, webinarsListAbsenteesResponseRegistrantsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsListAbsenteesResponseRegistrantsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsListAbsenteesResponseRegistrantsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsListAbsenteesResponseRegistrantsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsListAbsenteesResponseRegistrantsInner is not found in the empty JSON string", WebinarsListAbsenteesResponseRegistrantsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebinarsListAbsenteesResponseRegistrantsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("custom_questions") != null && !jsonObj.get("custom_questions").isJsonNull()) {
        ...
        if (jsonArraycustomQuestions != null) {
          ...
          for (int i = 0; i < jsonArraycustomQuestions.size(); i++) {
            WebinarsListAbsenteesResponseRegistrantsInnerCustomQuestionsInner.validateJsonObject(jsonArraycustomQuestions.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsListAbsenteesResponseRegistrantsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsListAbsenteesResponseRegistrantsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsListAbsenteesResponseRegistrantsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsListAbsenteesResponseRegistrantsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsListAbsenteesResponseRegistrantsInner>() {
           @Override
           public void write(JsonWriter out, WebinarsListAbsenteesResponseRegistrantsInner value) throws IOException {
           ...
           @Override
           public WebinarsListAbsenteesResponseRegistrantsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsListAbsenteesResponseRegistrantsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsListAbsenteesResponseRegistrantsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsListAbsenteesResponseRegistrantsInner
  * @throws IOException if the JSON string is invalid with respect to WebinarsListAbsenteesResponseRegistrantsInner
  */
  public static WebinarsListAbsenteesResponseRegistrantsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsListAbsenteesResponseRegistrantsInner.class);
  }

 /**
  * Convert an instance of WebinarsListAbsenteesResponseRegistrantsInner to an JSON string
  *
  * @return JSON string
  */
