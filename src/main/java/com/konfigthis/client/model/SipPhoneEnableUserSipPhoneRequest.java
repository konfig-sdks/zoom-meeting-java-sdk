...
public class SipPhoneEnableUserSipPhoneRequest {
 ...
 public enum TransportProtocol3Enum {
  ...
  public SipPhoneEnableUserSipPhoneRequest() {
  }

  public SipPhoneEnableUserSipPhoneRequest authorizationName(String authorizationName) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest domain(String domain) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest password(String password) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest proxyServer(String proxyServer) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest proxyServer2(String proxyServer2) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest proxyServer3(String proxyServer3) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest registerServer(String registerServer) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest registerServer2(String registerServer2) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest registerServer3(String registerServer3) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest registrationExpireTime(Integer registrationExpireTime) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest transportProtocol(TransportProtocolEnum transportProtocol) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest transportProtocol2(TransportProtocol2Enum transportProtocol2) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest transportProtocol3(TransportProtocol3Enum transportProtocol3) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest userEmail(String userEmail) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "jchill@example.com", required = true, value = "The email address of the user to associate with the SIP Phone. Can add `.win`, `.mac`, `.android`, `.ipad`, `.iphone`, `.linux`, `.pc`, `.mobile`, `.pad` at the end of the email (for example, `user@example.com.mac`) to add accounts for different platforms for the same user.")
  ...
  public SipPhoneEnableUserSipPhoneRequest userName(String userName) {
  ...
  **/
  ...
  public SipPhoneEnableUserSipPhoneRequest voiceMail(String voiceMail) {
  ...
  **/
   ...
   * @return the SipPhoneEnableUserSipPhoneRequest instance itself
   */
  public SipPhoneEnableUserSipPhoneRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SipPhoneEnableUserSipPhoneRequest sipPhoneEnableUserSipPhoneRequest = (SipPhoneEnableUserSipPhoneRequest) o;
    return Objects.equals(this.authorizationName, sipPhoneEnableUserSipPhoneRequest.authorizationName) &&
        Objects.equals(this.domain, sipPhoneEnableUserSipPhoneRequest.domain) &&
        Objects.equals(this.password, sipPhoneEnableUserSipPhoneRequest.password) &&
        Objects.equals(this.proxyServer, sipPhoneEnableUserSipPhoneRequest.proxyServer) &&
        Objects.equals(this.proxyServer2, sipPhoneEnableUserSipPhoneRequest.proxyServer2) &&
        Objects.equals(this.proxyServer3, sipPhoneEnableUserSipPhoneRequest.proxyServer3) &&
        Objects.equals(this.registerServer, sipPhoneEnableUserSipPhoneRequest.registerServer) &&
        Objects.equals(this.registerServer2, sipPhoneEnableUserSipPhoneRequest.registerServer2) &&
        Objects.equals(this.registerServer3, sipPhoneEnableUserSipPhoneRequest.registerServer3) &&
        Objects.equals(this.registrationExpireTime, sipPhoneEnableUserSipPhoneRequest.registrationExpireTime) &&
        Objects.equals(this.transportProtocol, sipPhoneEnableUserSipPhoneRequest.transportProtocol) &&
        Objects.equals(this.transportProtocol2, sipPhoneEnableUserSipPhoneRequest.transportProtocol2) &&
        Objects.equals(this.transportProtocol3, sipPhoneEnableUserSipPhoneRequest.transportProtocol3) &&
        Objects.equals(this.userEmail, sipPhoneEnableUserSipPhoneRequest.userEmail) &&
        Objects.equals(this.userName, sipPhoneEnableUserSipPhoneRequest.userName) &&
        Objects.equals(this.voiceMail, sipPhoneEnableUserSipPhoneRequest.voiceMail)&&
        Objects.equals(this.additionalProperties, sipPhoneEnableUserSipPhoneRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationName, domain, password, proxyServer, proxyServer2, proxyServer3, registerServer, registerServer2, registerServer3, registrationExpireTime, transportProtocol, transportProtocol2, transportProtocol3, userEmail, userName, voiceMail, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SipPhoneEnableUserSipPhoneRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SipPhoneEnableUserSipPhoneRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SipPhoneEnableUserSipPhoneRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SipPhoneEnableUserSipPhoneRequest is not found in the empty JSON string", SipPhoneEnableUserSipPhoneRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SipPhoneEnableUserSipPhoneRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SipPhoneEnableUserSipPhoneRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SipPhoneEnableUserSipPhoneRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SipPhoneEnableUserSipPhoneRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SipPhoneEnableUserSipPhoneRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SipPhoneEnableUserSipPhoneRequest>() {
           @Override
           public void write(JsonWriter out, SipPhoneEnableUserSipPhoneRequest value) throws IOException {
           ...
           @Override
           public SipPhoneEnableUserSipPhoneRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SipPhoneEnableUserSipPhoneRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SipPhoneEnableUserSipPhoneRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SipPhoneEnableUserSipPhoneRequest
  * @throws IOException if the JSON string is invalid with respect to SipPhoneEnableUserSipPhoneRequest
  */
  public static SipPhoneEnableUserSipPhoneRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SipPhoneEnableUserSipPhoneRequest.class);
  }

 /**
  * Convert an instance of SipPhoneEnableUserSipPhoneRequest to an JSON string
  *
  * @return JSON string
  */
