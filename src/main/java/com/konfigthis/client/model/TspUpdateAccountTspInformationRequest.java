...
public class TspUpdateAccountTspInformationRequest {
 ...
 public enum TspBridgeEnum {
  ...
  public TspUpdateAccountTspInformationRequest() {
  }

  public TspUpdateAccountTspInformationRequest dialInNumberUnrestricted(Boolean dialInNumberUnrestricted) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Control restriction on account users adding a TSP number outside of account's dial in numbers.")
  ...
  public TspUpdateAccountTspInformationRequest enable(Boolean enable) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Enable 3rd party audio conferencing for account users")
  ...
  public TspUpdateAccountTspInformationRequest masterAccountSettingExtended(Boolean masterAccountSettingExtended) {
  ...
  **/
  ...
  public TspUpdateAccountTspInformationRequest modifyCredentialForbidden(Boolean modifyCredentialForbidden) {
  ...
  **/
  ...
  public TspUpdateAccountTspInformationRequest tspBridge(TspBridgeEnum tspBridge) {
  ...
  **/
  ...
  public TspUpdateAccountTspInformationRequest tspEnabled(Boolean tspEnabled) {
  ...
  **/
  ...
  public TspUpdateAccountTspInformationRequest tspProvider(String tspProvider) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "someprovidername", value = "3rd party audio conferencing provider")
   ...
   * @return the TspUpdateAccountTspInformationRequest instance itself
   */
  public TspUpdateAccountTspInformationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TspUpdateAccountTspInformationRequest tspUpdateAccountTspInformationRequest = (TspUpdateAccountTspInformationRequest) o;
    return Objects.equals(this.dialInNumberUnrestricted, tspUpdateAccountTspInformationRequest.dialInNumberUnrestricted) &&
        Objects.equals(this.enable, tspUpdateAccountTspInformationRequest.enable) &&
        Objects.equals(this.masterAccountSettingExtended, tspUpdateAccountTspInformationRequest.masterAccountSettingExtended) &&
        Objects.equals(this.modifyCredentialForbidden, tspUpdateAccountTspInformationRequest.modifyCredentialForbidden) &&
        Objects.equals(this.tspBridge, tspUpdateAccountTspInformationRequest.tspBridge) &&
        Objects.equals(this.tspEnabled, tspUpdateAccountTspInformationRequest.tspEnabled) &&
        Objects.equals(this.tspProvider, tspUpdateAccountTspInformationRequest.tspProvider)&&
        Objects.equals(this.additionalProperties, tspUpdateAccountTspInformationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dialInNumberUnrestricted, enable, masterAccountSettingExtended, modifyCredentialForbidden, tspBridge, tspEnabled, tspProvider, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TspUpdateAccountTspInformationRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TspUpdateAccountTspInformationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TspUpdateAccountTspInformationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TspUpdateAccountTspInformationRequest is not found in the empty JSON string", TspUpdateAccountTspInformationRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TspUpdateAccountTspInformationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TspUpdateAccountTspInformationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TspUpdateAccountTspInformationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TspUpdateAccountTspInformationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TspUpdateAccountTspInformationRequest>() {
           @Override
           public void write(JsonWriter out, TspUpdateAccountTspInformationRequest value) throws IOException {
           ...
           @Override
           public TspUpdateAccountTspInformationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TspUpdateAccountTspInformationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TspUpdateAccountTspInformationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TspUpdateAccountTspInformationRequest
  * @throws IOException if the JSON string is invalid with respect to TspUpdateAccountTspInformationRequest
  */
  public static TspUpdateAccountTspInformationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TspUpdateAccountTspInformationRequest.class);
  }

 /**
  * Convert an instance of TspUpdateAccountTspInformationRequest to an JSON string
  *
  * @return JSON string
  */
