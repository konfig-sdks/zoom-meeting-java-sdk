...
public class ArchivingMeetingFilesListResponseMeetingsInner {
  ...
  private List<ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner> archiveFiles = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner() {
  }

  public ArchivingMeetingFilesListResponseMeetingsInner accountName(String accountName) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner archiveFiles(List<ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner> archiveFiles) {
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner addArchiveFilesItem(ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner archiveFilesItem) {
  ...
  **/
  ...
  public List<ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner> getArchiveFiles() {
    return archiveFiles;
  }


  public void setArchiveFiles(List<ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner> archiveFiles) {
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner completeTime(Object completeTime) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner duration(Integer duration) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner durationInSecond(Integer durationInSecond) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner hostId(String hostId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Dhjdfgdkg8w", required = true, value = "The ID of the user set as the host of the archived meeting or webinar.")
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner id(Long id) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner isBreakoutRoom(Boolean isBreakoutRoom) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner meetingType(MeetingTypeEnum meetingType) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner parentMeetingId(String parentMeetingId) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner recordingCount(Integer recordingCount) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner timezone(String timezone) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner topic(String topic) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner totalSize(Integer totalSize) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner type(TypeEnum type) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner uuid(String uuid) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "yO3dfhh3t467UkQ==", required = true, value = "The recorded meeting or webinar instance's universally unique identifier (UUID). Each meeting or webinar instance generates a UUID.")
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner status(StatusEnum status) {
  ...
  **/
  ...
  public ArchivingMeetingFilesListResponseMeetingsInner groupId(String groupId) {
  ...
  **/
   ...
   * @return the ArchivingMeetingFilesListResponseMeetingsInner instance itself
   */
  public ArchivingMeetingFilesListResponseMeetingsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ArchivingMeetingFilesListResponseMeetingsInner archivingMeetingFilesListResponseMeetingsInner = (ArchivingMeetingFilesListResponseMeetingsInner) o;
    return Objects.equals(this.accountName, archivingMeetingFilesListResponseMeetingsInner.accountName) &&
        Objects.equals(this.archiveFiles, archivingMeetingFilesListResponseMeetingsInner.archiveFiles) &&
        Objects.equals(this.completeTime, archivingMeetingFilesListResponseMeetingsInner.completeTime) &&
        Objects.equals(this.duration, archivingMeetingFilesListResponseMeetingsInner.duration) &&
        Objects.equals(this.durationInSecond, archivingMeetingFilesListResponseMeetingsInner.durationInSecond) &&
        Objects.equals(this.hostId, archivingMeetingFilesListResponseMeetingsInner.hostId) &&
        Objects.equals(this.id, archivingMeetingFilesListResponseMeetingsInner.id) &&
        Objects.equals(this.isBreakoutRoom, archivingMeetingFilesListResponseMeetingsInner.isBreakoutRoom) &&
        Objects.equals(this.meetingType, archivingMeetingFilesListResponseMeetingsInner.meetingType) &&
        Objects.equals(this.parentMeetingId, archivingMeetingFilesListResponseMeetingsInner.parentMeetingId) &&
        Objects.equals(this.recordingCount, archivingMeetingFilesListResponseMeetingsInner.recordingCount) &&
        Objects.equals(this.startTime, archivingMeetingFilesListResponseMeetingsInner.startTime) &&
        Objects.equals(this.timezone, archivingMeetingFilesListResponseMeetingsInner.timezone) &&
        Objects.equals(this.topic, archivingMeetingFilesListResponseMeetingsInner.topic) &&
        Objects.equals(this.totalSize, archivingMeetingFilesListResponseMeetingsInner.totalSize) &&
        Objects.equals(this.type, archivingMeetingFilesListResponseMeetingsInner.type) &&
        Objects.equals(this.uuid, archivingMeetingFilesListResponseMeetingsInner.uuid) &&
        Objects.equals(this.status, archivingMeetingFilesListResponseMeetingsInner.status) &&
        Objects.equals(this.groupId, archivingMeetingFilesListResponseMeetingsInner.groupId)&&
        Objects.equals(this.additionalProperties, archivingMeetingFilesListResponseMeetingsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArchivingMeetingFilesListResponseMeetingsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ArchivingMeetingFilesListResponseMeetingsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ArchivingMeetingFilesListResponseMeetingsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArchivingMeetingFilesListResponseMeetingsInner is not found in the empty JSON string", ArchivingMeetingFilesListResponseMeetingsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ArchivingMeetingFilesListResponseMeetingsInner.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayarchiveFiles.size(); i++) {
        ArchivingMeetingFilesListResponseMeetingsInnerArchiveFilesInner.validateJsonObject(jsonArrayarchiveFiles.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArchivingMeetingFilesListResponseMeetingsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArchivingMeetingFilesListResponseMeetingsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArchivingMeetingFilesListResponseMeetingsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArchivingMeetingFilesListResponseMeetingsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ArchivingMeetingFilesListResponseMeetingsInner>() {
           @Override
           public void write(JsonWriter out, ArchivingMeetingFilesListResponseMeetingsInner value) throws IOException {
           ...
           @Override
           public ArchivingMeetingFilesListResponseMeetingsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ArchivingMeetingFilesListResponseMeetingsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ArchivingMeetingFilesListResponseMeetingsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ArchivingMeetingFilesListResponseMeetingsInner
  * @throws IOException if the JSON string is invalid with respect to ArchivingMeetingFilesListResponseMeetingsInner
  */
  public static ArchivingMeetingFilesListResponseMeetingsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArchivingMeetingFilesListResponseMeetingsInner.class);
  }

 /**
  * Convert an instance of ArchivingMeetingFilesListResponseMeetingsInner to an JSON string
  *
  * @return JSON string
  */
