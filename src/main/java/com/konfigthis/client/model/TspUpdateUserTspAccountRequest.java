 ...
 * TSP account.
 */
@ApiModel(description = "TSP account.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TspUpdateUserTspAccountRequest {
  ...
  private List<TspUpdateUserTspAccountRequestDialInNumbersInner> dialInNumbers = null;
 ...
 public enum TspBridgeEnum {
  ...
  public TspUpdateUserTspAccountRequest() {
  }

  public TspUpdateUserTspAccountRequest conferenceCode(String conferenceCode) {
  ...
  **/
  ...
  public TspUpdateUserTspAccountRequest dialInNumbers(List<TspUpdateUserTspAccountRequestDialInNumbersInner> dialInNumbers) {
  ...
  public TspUpdateUserTspAccountRequest addDialInNumbersItem(TspUpdateUserTspAccountRequestDialInNumbersInner dialInNumbersItem) {
  ...
  **/
  ...
  public List<TspUpdateUserTspAccountRequestDialInNumbersInner> getDialInNumbers() {
    return dialInNumbers;
  }


  public void setDialInNumbers(List<TspUpdateUserTspAccountRequestDialInNumbersInner> dialInNumbers) {
  ...
  public TspUpdateUserTspAccountRequest leaderPin(String leaderPin) {
  ...
  **/
  ...
  public TspUpdateUserTspAccountRequest tspBridge(TspBridgeEnum tspBridge) {
  ...
  **/
   ...
   * @return the TspUpdateUserTspAccountRequest instance itself
   */
  public TspUpdateUserTspAccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TspUpdateUserTspAccountRequest tspUpdateUserTspAccountRequest = (TspUpdateUserTspAccountRequest) o;
    return Objects.equals(this.conferenceCode, tspUpdateUserTspAccountRequest.conferenceCode) &&
        Objects.equals(this.dialInNumbers, tspUpdateUserTspAccountRequest.dialInNumbers) &&
        Objects.equals(this.leaderPin, tspUpdateUserTspAccountRequest.leaderPin) &&
        Objects.equals(this.tspBridge, tspUpdateUserTspAccountRequest.tspBridge)&&
        Objects.equals(this.additionalProperties, tspUpdateUserTspAccountRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TspUpdateUserTspAccountRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TspUpdateUserTspAccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TspUpdateUserTspAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TspUpdateUserTspAccountRequest is not found in the empty JSON string", TspUpdateUserTspAccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TspUpdateUserTspAccountRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("dial_in_numbers") != null && !jsonObj.get("dial_in_numbers").isJsonNull()) {
        ...
        if (jsonArraydialInNumbers != null) {
          ...
          for (int i = 0; i < jsonArraydialInNumbers.size(); i++) {
            TspUpdateUserTspAccountRequestDialInNumbersInner.validateJsonObject(jsonArraydialInNumbers.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TspUpdateUserTspAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TspUpdateUserTspAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TspUpdateUserTspAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TspUpdateUserTspAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TspUpdateUserTspAccountRequest>() {
           @Override
           public void write(JsonWriter out, TspUpdateUserTspAccountRequest value) throws IOException {
           ...
           @Override
           public TspUpdateUserTspAccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TspUpdateUserTspAccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TspUpdateUserTspAccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TspUpdateUserTspAccountRequest
  * @throws IOException if the JSON string is invalid with respect to TspUpdateUserTspAccountRequest
  */
  public static TspUpdateUserTspAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TspUpdateUserTspAccountRequest.class);
  }

 /**
  * Convert an instance of TspUpdateUserTspAccountRequest to an JSON string
  *
  * @return JSON string
  */
