...
public class CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner {
 ...
 public enum StatusEnum {
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner() {
  }

  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner deletedTime(String deletedTime) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner downloadUrl(String downloadUrl) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner filePath(String filePath) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner fileSize(Double fileSize) {
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner fileSize(Integer fileSize) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner fileType(FileTypeEnum fileType) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner fileExtension(FileExtensionEnum fileExtension) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "72576a1f-4e66-4a77-87c4-f13f9808bd76", value = "The recording file ID. It's included in the response of general query.")
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner meetingId(String meetingId) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner playUrl(String playUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://example.com/rec/play/Qg75t7xZBtEbAkjdlgbfdngBBBB", value = "The URL that can play a recording file.")
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner recordingEnd(String recordingEnd) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-03-18T05:41:36Z", value = "The recording end time. The response is in general query.")
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner recordingStart(String recordingStart) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner recordingType(RecordingTypeEnum recordingType) {
  ...
  **/
  ...
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner status(StatusEnum status) {
  ...
  **/
   ...
   * @return the CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner instance itself
   */
  public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner = (CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner) o;
    return Objects.equals(this.deletedTime, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.deletedTime) &&
        Objects.equals(this.downloadUrl, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.downloadUrl) &&
        Objects.equals(this.filePath, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.filePath) &&
        Objects.equals(this.fileSize, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.fileSize) &&
        Objects.equals(this.fileType, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.fileType) &&
        Objects.equals(this.fileExtension, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.fileExtension) &&
        Objects.equals(this.id, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.id) &&
        Objects.equals(this.meetingId, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.meetingId) &&
        Objects.equals(this.playUrl, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.playUrl) &&
        Objects.equals(this.recordingEnd, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.recordingEnd) &&
        Objects.equals(this.recordingStart, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.recordingStart) &&
        Objects.equals(this.recordingType, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.recordingType) &&
        Objects.equals(this.status, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.status)&&
        Objects.equals(this.additionalProperties, cloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner is not found in the empty JSON string", CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner>() {
           @Override
           public void write(JsonWriter out, CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner value) throws IOException {
           ...
           @Override
           public CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner
  * @throws IOException if the JSON string is invalid with respect to CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner
  */
  public static CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner.class);
  }

 /**
  * Convert an instance of CloudRecordingGetMeetingRecordingsResponseRecordingFilesInner to an JSON string
  *
  * @return JSON string
  */
