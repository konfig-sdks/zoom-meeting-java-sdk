...
import com.konfigthis.client.model.MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner;
...
public class MeetingAndWebinarPollingObject1QuestionsInner {
  ...
  private List<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner() {
  }

  public MeetingAndWebinarPollingObject1QuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner answers(List<String> answers) {
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner name(String name) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner prompts(List<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner addPromptsItem(MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner> prompts) {
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public MeetingAndWebinarPollingObject1QuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the MeetingAndWebinarPollingObject1QuestionsInner instance itself
   */
  public MeetingAndWebinarPollingObject1QuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingAndWebinarPollingObject1QuestionsInner meetingAndWebinarPollingObject1QuestionsInner = (MeetingAndWebinarPollingObject1QuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, meetingAndWebinarPollingObject1QuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, meetingAndWebinarPollingObject1QuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, meetingAndWebinarPollingObject1QuestionsInner.answerRequired) &&
        Objects.equals(this.answers, meetingAndWebinarPollingObject1QuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, meetingAndWebinarPollingObject1QuestionsInner.caseSensitive) &&
        Objects.equals(this.name, meetingAndWebinarPollingObject1QuestionsInner.name) &&
        Objects.equals(this.prompts, meetingAndWebinarPollingObject1QuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, meetingAndWebinarPollingObject1QuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, meetingAndWebinarPollingObject1QuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, meetingAndWebinarPollingObject1QuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, meetingAndWebinarPollingObject1QuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, meetingAndWebinarPollingObject1QuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, meetingAndWebinarPollingObject1QuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, meetingAndWebinarPollingObject1QuestionsInner.type)&&
        Objects.equals(this.additionalProperties, meetingAndWebinarPollingObject1QuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MeetingAndWebinarPollingObject1QuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MeetingAndWebinarPollingObject1QuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MeetingAndWebinarPollingObject1QuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingAndWebinarPollingObject1QuestionsInner is not found in the empty JSON string", MeetingAndWebinarPollingObject1QuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            MeetingAndWebinarPollingObject1QuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingAndWebinarPollingObject1QuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingAndWebinarPollingObject1QuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingAndWebinarPollingObject1QuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingAndWebinarPollingObject1QuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingAndWebinarPollingObject1QuestionsInner>() {
           @Override
           public void write(JsonWriter out, MeetingAndWebinarPollingObject1QuestionsInner value) throws IOException {
           ...
           @Override
           public MeetingAndWebinarPollingObject1QuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MeetingAndWebinarPollingObject1QuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MeetingAndWebinarPollingObject1QuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeetingAndWebinarPollingObject1QuestionsInner
  * @throws IOException if the JSON string is invalid with respect to MeetingAndWebinarPollingObject1QuestionsInner
  */
  public static MeetingAndWebinarPollingObject1QuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingAndWebinarPollingObject1QuestionsInner.class);
  }

 /**
  * Convert an instance of MeetingAndWebinarPollingObject1QuestionsInner to an JSON string
  *
  * @return JSON string
  */
