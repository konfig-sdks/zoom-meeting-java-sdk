...
import com.konfigthis.client.model.WebinarsCreatePollRequestQuestionsInnerPromptsInner;
...
public class WebinarsCreatePollRequestQuestionsInner {
  ...
  private List<WebinarsCreatePollRequestQuestionsInnerPromptsInner> prompts = null;
 ...
 public enum TypeEnum {
  ...
  public WebinarsCreatePollRequestQuestionsInner() {
  }

  public WebinarsCreatePollRequestQuestionsInner answerMaxCharacter(Integer answerMaxCharacter) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner answerMinCharacter(Integer answerMinCharacter) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner answerRequired(Boolean answerRequired) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner answers(List<String> answers) {
  ...
  public WebinarsCreatePollRequestQuestionsInner addAnswersItem(String answersItem) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner name(String name) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner prompts(List<WebinarsCreatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsCreatePollRequestQuestionsInner addPromptsItem(WebinarsCreatePollRequestQuestionsInnerPromptsInner promptsItem) {
  ...
  **/
  ...
  public List<WebinarsCreatePollRequestQuestionsInnerPromptsInner> getPrompts() {
    return prompts;
  }


  public void setPrompts(List<WebinarsCreatePollRequestQuestionsInnerPromptsInner> prompts) {
  ...
  public WebinarsCreatePollRequestQuestionsInner ratingMaxLabel(String ratingMaxLabel) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner ratingMaxValue(Integer ratingMaxValue) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner ratingMinLabel(String ratingMinLabel) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner ratingMinValue(Integer ratingMinValue) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner rightAnswers(List<String> rightAnswers) {
  ...
  public WebinarsCreatePollRequestQuestionsInner addRightAnswersItem(String rightAnswersItem) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner showAsDropdown(Boolean showAsDropdown) {
  ...
  **/
  ...
  public WebinarsCreatePollRequestQuestionsInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the WebinarsCreatePollRequestQuestionsInner instance itself
   */
  public WebinarsCreatePollRequestQuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebinarsCreatePollRequestQuestionsInner webinarsCreatePollRequestQuestionsInner = (WebinarsCreatePollRequestQuestionsInner) o;
    return Objects.equals(this.answerMaxCharacter, webinarsCreatePollRequestQuestionsInner.answerMaxCharacter) &&
        Objects.equals(this.answerMinCharacter, webinarsCreatePollRequestQuestionsInner.answerMinCharacter) &&
        Objects.equals(this.answerRequired, webinarsCreatePollRequestQuestionsInner.answerRequired) &&
        Objects.equals(this.answers, webinarsCreatePollRequestQuestionsInner.answers) &&
        Objects.equals(this.caseSensitive, webinarsCreatePollRequestQuestionsInner.caseSensitive) &&
        Objects.equals(this.name, webinarsCreatePollRequestQuestionsInner.name) &&
        Objects.equals(this.prompts, webinarsCreatePollRequestQuestionsInner.prompts) &&
        Objects.equals(this.ratingMaxLabel, webinarsCreatePollRequestQuestionsInner.ratingMaxLabel) &&
        Objects.equals(this.ratingMaxValue, webinarsCreatePollRequestQuestionsInner.ratingMaxValue) &&
        Objects.equals(this.ratingMinLabel, webinarsCreatePollRequestQuestionsInner.ratingMinLabel) &&
        Objects.equals(this.ratingMinValue, webinarsCreatePollRequestQuestionsInner.ratingMinValue) &&
        Objects.equals(this.rightAnswers, webinarsCreatePollRequestQuestionsInner.rightAnswers) &&
        Objects.equals(this.showAsDropdown, webinarsCreatePollRequestQuestionsInner.showAsDropdown) &&
        Objects.equals(this.type, webinarsCreatePollRequestQuestionsInner.type)&&
        Objects.equals(this.additionalProperties, webinarsCreatePollRequestQuestionsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarsCreatePollRequestQuestionsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebinarsCreatePollRequestQuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebinarsCreatePollRequestQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebinarsCreatePollRequestQuestionsInner is not found in the empty JSON string", WebinarsCreatePollRequestQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("prompts") != null && !jsonObj.get("prompts").isJsonNull()) {
        ...
        if (jsonArrayprompts != null) {
          ...
          for (int i = 0; i < jsonArrayprompts.size(); i++) {
            WebinarsCreatePollRequestQuestionsInnerPromptsInner.validateJsonObject(jsonArrayprompts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebinarsCreatePollRequestQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebinarsCreatePollRequestQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebinarsCreatePollRequestQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebinarsCreatePollRequestQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebinarsCreatePollRequestQuestionsInner>() {
           @Override
           public void write(JsonWriter out, WebinarsCreatePollRequestQuestionsInner value) throws IOException {
           ...
           @Override
           public WebinarsCreatePollRequestQuestionsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebinarsCreatePollRequestQuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebinarsCreatePollRequestQuestionsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebinarsCreatePollRequestQuestionsInner
  * @throws IOException if the JSON string is invalid with respect to WebinarsCreatePollRequestQuestionsInner
  */
  public static WebinarsCreatePollRequestQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebinarsCreatePollRequestQuestionsInner.class);
  }

 /**
  * Convert an instance of WebinarsCreatePollRequestQuestionsInner to an JSON string
  *
  * @return JSON string
  */
