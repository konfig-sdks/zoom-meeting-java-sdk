...
import com.konfigthis.client.model.TspGetUserTspAccountResponseDialInNumbersInner;
 ...
 */
@ApiModel(description = "TSP account of the user.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TspGetUserTspAccountResponse {
  ...
  private List<TspGetUserTspAccountResponseDialInNumbersInner> dialInNumbers = null;
 ...
 public enum TspBridgeEnum {
  ...
  public TspGetUserTspAccountResponse() {
  }

  public TspGetUserTspAccountResponse conferenceCode(String conferenceCode) {
  ...
  **/
  ...
  public TspGetUserTspAccountResponse dialInNumbers(List<TspGetUserTspAccountResponseDialInNumbersInner> dialInNumbers) {
  ...
  public TspGetUserTspAccountResponse addDialInNumbersItem(TspGetUserTspAccountResponseDialInNumbersInner dialInNumbersItem) {
  ...
  **/
  ...
  public List<TspGetUserTspAccountResponseDialInNumbersInner> getDialInNumbers() {
    return dialInNumbers;
  }


  public void setDialInNumbers(List<TspGetUserTspAccountResponseDialInNumbersInner> dialInNumbers) {
  ...
  public TspGetUserTspAccountResponse id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The TSP account ID.")
  ...
  public TspGetUserTspAccountResponse leaderPin(String leaderPin) {
  ...
  **/
  ...
  public TspGetUserTspAccountResponse tspBridge(TspBridgeEnum tspBridge) {
  ...
  **/
   ...
   * @return the TspGetUserTspAccountResponse instance itself
   */
  public TspGetUserTspAccountResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TspGetUserTspAccountResponse tspGetUserTspAccountResponse = (TspGetUserTspAccountResponse) o;
    return Objects.equals(this.conferenceCode, tspGetUserTspAccountResponse.conferenceCode) &&
        Objects.equals(this.dialInNumbers, tspGetUserTspAccountResponse.dialInNumbers) &&
        Objects.equals(this.id, tspGetUserTspAccountResponse.id) &&
        Objects.equals(this.leaderPin, tspGetUserTspAccountResponse.leaderPin) &&
        Objects.equals(this.tspBridge, tspGetUserTspAccountResponse.tspBridge)&&
        Objects.equals(this.additionalProperties, tspGetUserTspAccountResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TspGetUserTspAccountResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TspGetUserTspAccountResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TspGetUserTspAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TspGetUserTspAccountResponse is not found in the empty JSON string", TspGetUserTspAccountResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TspGetUserTspAccountResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("dial_in_numbers") != null && !jsonObj.get("dial_in_numbers").isJsonNull()) {
        ...
        if (jsonArraydialInNumbers != null) {
          ...
          for (int i = 0; i < jsonArraydialInNumbers.size(); i++) {
            TspGetUserTspAccountResponseDialInNumbersInner.validateJsonObject(jsonArraydialInNumbers.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TspGetUserTspAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TspGetUserTspAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TspGetUserTspAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TspGetUserTspAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TspGetUserTspAccountResponse>() {
           @Override
           public void write(JsonWriter out, TspGetUserTspAccountResponse value) throws IOException {
           ...
           @Override
           public TspGetUserTspAccountResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TspGetUserTspAccountResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TspGetUserTspAccountResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TspGetUserTspAccountResponse
  * @throws IOException if the JSON string is invalid with respect to TspGetUserTspAccountResponse
  */
  public static TspGetUserTspAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TspGetUserTspAccountResponse.class);
  }

 /**
  * Convert an instance of TspGetUserTspAccountResponse to an JSON string
  *
  * @return JSON string
  */
